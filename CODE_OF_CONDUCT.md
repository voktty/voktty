...
Voktty is a small open-source project and we want it to stay a place people enjoy contributing to.
...
- **Stay on topic.** Issues, PRs, and discussions are about Voktty. Take off-topic conversations elsewhere.
...
If you see a violation - or experience one - email **hi@voktty.dev** with subject `[Voktty conduct]`. Include links and context.
