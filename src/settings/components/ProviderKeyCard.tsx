...
export function ProviderKeyCard({
  ...
  const submit = async () => {
    ...
    if (provider.keyPrefix && !trimmed.startsWith(provider.keyPrefix)) {
      setError(t("settings.models.keyPrefixError", { label: provider.label, prefix: provider.keyPrefix ?? "" }));
      return;
    }
    setSaving(true);
    setError(null);
    try {
      ...
      setError(t("settings.models.failedToSave", { error: String(e) }));
    } finally {
      setSaving(false);
    }
  };
          ...
          <div className="flex gap-1.5">
            <div className="relative flex-1">
              ...
              <button
                ...
                aria-label={reveal ? t("settings.models.hideKey") : t("settings.models.showKey")}
              >
                <HugeiconsIcon
