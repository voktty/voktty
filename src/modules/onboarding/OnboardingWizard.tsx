...
import { SUPPORTED_LANGUAGES, type LanguageId } from "@/modules/i18n/types";
import {
  setDefaultModel,
  setEditorFontSize,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className="fixed inset-0 top-0 left-0 z-50 w-screen h-[100dvh] max-w-none max-h-none translate-x-0 translate-y-0 overflow-hidden flex flex-row rounded-none border-0 bg-card/95 backdrop-blur-2xl shadow-none p-0 gap-0 select-none"
      >
                          ...
                          <div className="relative">
                            ...
                            <div className="absolute right-1.5 top-1/2 -translate-y-1/2 flex items-center gap-1">
                              ...
                              >
                                <HugeiconsIcon
                                  icon={
                                    keyState.visible ? ViewOffIcon : ViewIcon
                                  }
                                  size={13}
                                />
                              </button>
                  ...
                  <div className="grid grid-cols-2 gap-2 text-[11px]">
                    ...
                    <div className="p-2.5 rounded-lg bg-secondary/35 border border-border/60">
                      ...
                      <p className="font-medium text-foreground mt-0.5 truncate">
                        {FEATURED_THEMES.find((th) => th.id === prefs.themeId)
                          ?.name || prefs.themeId}
                      </p>
                    </div>
