      ...
      >
        <div className="flex min-w-0 items-center gap-2.5 px-3 py-2.5">
          ...
          <div className="flex shrink-0 items-center gap-0.5">
            <button
              ...
              title={
                canUndoAll
                  ? t("sessionReview.undoAllSessionChanges")
                  : undoLocked
                    ? t("sessionReview.undoLockedOtherSession")
                    : t("sessionReview.undoUnavailableExternal")
              }
            ...
            >
              {t("sessionReview.undo")}
            </button>
            <button
              type="button"
              title={t("sessionReview.keepAllSessionChanges")}
              disabled={disabled}
              onClick={() => run("keep")}
              className="h-7 rounded-md px-2.5 text-[11px] text-content/50 hover:bg-content/8 hover:text-content disabled:opacity-35"
            >
              {t("sessionReview.keep")}
            </button>
            <button
              type="button"
        ...
        {files.length > 3 ? (
          ...
          >
            ...
            <span>
              {expanded
                ? t("sessionReview.showFewerFiles")
                : t("sessionReview.showMoreFiles", { count: hiddenFileCount })}
            </span>
          </button>
        ) : null}
      </div>
