...
export const NOTIFICATIONS_CHANGE_EVENT = "voktty:notifications-change";

/** Rust / OS emits this with the session id when a notification is clicked. */
export const NOTIFICATION_CLICK_EVENT = "voktty:notification-click";
 ...
 * webviews can keep reporting true after the window drops to the background.
 */
let windowFocused =
