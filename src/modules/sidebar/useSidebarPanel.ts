...
const SIDEBAR_WIDTH_STORAGE_KEY = "voktty.sidebar.width";
const SIDEBAR_VIEW_STORAGE_KEY = "voktty.sidebar.view";
const SIDEBAR_COLLAPSED_STORAGE_KEY = "voktty.sidebar.collapsed";
