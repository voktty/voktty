...
const jaI18nBatch22: TranslationSchema = mergeLocale(jaI18nBatch21, {
  agentHistory: {
    ...
    messageLimitReached: "最初の {count} 件のメッセージを表示しています。すべてのメッセージはトランスクリプトをエクスポートしてください。",
...
const jaCoverageBase: TranslationSchema = mergeLocale(jaI18nBatch28, {
  aliases: {
    dialog: {
      enabled: "有効",
...
const jaCoveragePatch: TranslationSchema = mergeLocale(jaCoverageBase, {
  settings: {
    themes: {
      pack: {
        title: "外観パック",
        desc: "パレット、表面の立体感、タイポグラフィの事前設定の組み合わせ。",
      },
      autoFollow: "自動（パック/テーマに合わせる）",
      typography: {
        title: "タイポグラフィプロファイル",
        desc: "UI のフォント、サイズ、密度。",
      },
      surface: {
        title: "サーフェスプロファイル",
        desc: "キャンバス、サイドバー、パネルの透明度と立体感。",
      },
      variations: {
        title: "カラーバリエーション",
        matrixHint: "マトリックステーマ",
      },
    },
  },
  tabs: {
    subtitles: {
      harness: "エージェント開発ハーネス",
    },
  },
  statusbar: {
    arcade: "アーケード（パックマンとスネーク）",
    arcadeLabel: "アーケード",
    quota: {
      widgetTitle: "AI クォータとトークン使用量",
      widgetLabel: "AI クォータ",
      header: "AI クォータと消費",
      today: "今日: {cost}",
      resets: "リセット: {time}",
      tokensSummary: "入力: {inTokens} · 出力: {outTokens}",
      costUsd: "${cost}",
    },
  },
  explorer: {
    openInEditor: "エディターで開く",
    viewInBrowserPreview: "Web プレビューで表示",
  },
  git: {
    stash: {
      title: "スタッシュ",
      new: "新規",
      newTitle: "スタッシュを保存",
      newDesc: "現在の変更を一時退避し、後で戻せます。",
      messageLabel: "メッセージ（任意）",
      messagePlaceholder: "例: ログインフォーム作業中",
      includeUntracked: "未追跡ファイルを含める",
      saveAction: "スタッシュを保存",
      saveSuccess: "変更をスタッシュしました",
      empty: "スタッシュはありません",
      unnamed: "（メッセージなし）",
      apply: "適用",
      applySuccess: "スタッシュを適用しました",
      pop: "ポップ（適用して削除）",
      popSuccess: "スタッシュをポップしました",
      drop: "破棄",
      dropSuccess: "スタッシュを破棄しました",
    },
    tags: {
      title: "タグ",
      new: "新規",
      newTitle: "タグを作成",
      newDesc: "現在のコミット（HEAD）にタグを付けます。",
      newDescAt: "現在のコミット（{sha}）にタグを付けます。",
      nameLabel: "タグ名",
      namePlaceholder: "v1.0.0",
      messageLabel: "注釈メッセージ（任意）",
      messagePlaceholder: "例: リリースノート",
      messageHint: "空のままにすると軽量タグ、メッセージを入れると注釈付きタグになります。",
      createAction: "タグを作成",
      createSuccess: "タグ「{name}」を作成しました",
      empty: "タグはありません",
      push: "リモートにプッシュ",
      pushSuccess: "タグ「{name}」をプッシュしました",
      delete: "タグを削除",
      deleteSuccess: "タグ「{name}」を削除しました",
    },
    conflicts: {
      title: "コンフリクト",
      inProgressMerge: "マージ進行中",
      inProgressRevert: "リバート進行中",
      inProgressCherryPick: "チェリーピック進行中",
      inProgressRebase: "リベース進行中",
      resolveHint: "下の競合ファイルを解決してから続行または中止してください。",
      abort: "中止",
      aborting: "中止しています…",
      abortSuccess: "操作を中止しました",
      continue: "続行",
      continuing: "続行しています…",
      continueSuccess: "操作が完了しました",
      continueBlocked: "続行する前に、競合するすべてのファイルを解決してください。",
      dialogDesc: "競合する各変更で残す側を選び、ファイルを解決済みにしてください。",
      unresolvable: "このファイルはここでは解決できません（バイナリ、または視覚的なマーカーがありません）。ターミナルから解決してください。",
      hunkLabel: "コンフリクト {n}",
      acceptOurs: "こちら",
      acceptTheirs: "相手",
      acceptBoth: "両方",
      ...
      resolveAllHunks: "すべてのコンフリクトを解決（{resolved}/{total}）",
      resolvedSuccess: "{path} を解決済みにしました",
    },
    blame: {
      action: "Blame",
      dialogDesc: "各行を最後に変更した人とコミットを表示します。",
    },
    compare: {
      action: "ブランチを比較",
      title: "ブランチを比較",
      dialogDesc: "マージや PR の前に、2 つのブランチの差分を確認します。",
      selectBase: "ベースブランチ",
      selectCompare: "比較ブランチ",
      pickBothHint: "差分を見るにはベースと比較ブランチを選んでください。",
      aheadTitle: "{compare} にある（{count}）",
      aheadEmpty: "ベースブランチに既にあるもの以外はありません。",
      behindTitle: "{base} にある（{count}）",
      behindEmpty: "比較ブランチに既にあるもの以外はありません。",
      filesChanged: "変更ファイル（{count}）",
      noFileChanges: "これらのブランチ間にファイル変更はありません。",
    },
    sendToTerminal: "ターミナルに貼り付け",
    reviewSentToTerminal: "レビュー用プロンプトをアクティブなターミナルに挿入しました",
    noTerminalCopiedToClipboard: "アクティブなターミナルがありません。プロンプトをクリップボードにコピーしました。",
  },
  projectToolkit: {
    discoveredSkills: "検出されたスキル（{count}）",
    aiKits: "AI キットとスターター（{count}）",
    openSkillFile: "スキル定義ファイルをエディターで開く",
    copyInvocation: "スラッシュコマンドをコピー",
    aiSettings: "AI 設定",
    scopeProject: "プロジェクト",
  },
  projectTools: {
    eccUniversalInstall: {
      ...
      description: "エージェントハーネスの性能最適化システム。スキル、本能、メモリ、セキュリティ、調査優先の開発。",
    },
  },
  ai: {
    approvals: {
      browserClick: "プレビューでクリック",
      browserType: "プレビューで入力",
      browserEval: "プレビューで評価",
    },
    unreadMessages: "未読メッセージ {count} 件",
    collapseToBadge: "フローティングバッジに最小化",
  },
  shortcuts: {
    labels: {
      previewToggleInspector: "ライブコンポーネントインスペクターの切り替え",
    },
  },
  gitHistory: {
    revertCommit: "コミットをリバート",
    revertConfirmTitle: "このコミットをリバートしますか？",
    revertConfirmDescription: "「{subject}」（{sha}）を取り消す新しいコミットを作成します。履歴は書き換えませんが、後続のコミットが同じ行を変更しているとコンフリクトすることがあります。その場合は何も変わらず、ターミナルで解決が必要です。",
    revertSuccess: "コミットをリバートしました",
    revertFailed: "コミットをリバートできませんでした",
  },
  preview: {
    sendToAi: "このコンポーネントについて AI に尋ねる",
    copyReference: "コンポーネント参照をコピー",
    copiedReference: "参照をクリップボードにコピーしました",
    copyDebugPrompt: "デバッグプロンプトをコピー",
    copiedDebugPrompt: "デバッグプロンプトをクリップボードにコピーしました",
    copyModifyPrompt: "変更プロンプトをコピー",
    copiedModifyPrompt: "変更プロンプトをクリップボードにコピーしました",
    jumpToCode: "ソースコードへジャンプ",
    jumpingToCode: "エディターでファイルを開いています",
    badge: {
      searchingFile: "ファイルを探しています…",
      matchedByLabel: "{source} 経由",
      domBreadcrumbLabel: "DOM:",
      breadcrumbSeparatorIcon: "›",
      crumbCurrentTitle: "現在選択中の要素",
      crumbSelectTitle: "祖先を選択: {selector}",
      openInEditorTitle: "エディターで {path}:{line} を開く",
      copied: "コピーしました！",
      copyRefLabel: "参照をコピー",
      debugPromptLabel: "デバッグプロンプト",
      modifyPromptLabel: "変更プロンプト",
      stylesPromptLabel: "スタイルプロンプト",
      copyVisualPromptTitle: "AI の視覚的な再設計用にスタイルとボックスモデル付きプロンプトをコピー",
      detailsLabel: "詳細",
      detailsToggleShow: "技術詳細と HTML を表示",
      detailsToggleHide: "技術詳細を隠す",
      tabDomHtml: "DOM と HTML",
      tabComputedStyles: "計算済みスタイル",
      tabBoxModel: "ボックスモデル",
      domSelectorLabel: "DOM セレクター",
      copiedShort: "コピー済み",
      copyLabel: "コピー",
      visibleTextLabel: "表示テキスト",
      visibleTextValue: "「{text}」",
      htmlSnippetLabel: "HTML スニペット",
      htmlSnippetCopiedToast: "HTML スニペットをコピーしました",
      cssSelectorCopiedToast: "CSS セレクターをコピーしました",
      stylesPromptCopiedToast: "スタイルプロンプトをコピーしました",
      computedCssPropsLabel: "計算済み CSS プロパティ",
      noStylesAvailable: "この要素に利用できるスタイルはありません。",
      boxModelMarginLabel: "マージン（{value}px）",
      boxModelBorderLabel: "ボーダー（{value}px）",
      boxModelPaddingLabel: "パディング（{value}px）",
      boxModelBottomLabel: "下: {value}px",
      boxDimensionsLabel: "ボックス寸法: {width} × {height} px",
    },
    console: {
      heading: "コンソール",
      toggleIconOpen: "▼",
      ...
      filterWarnings: "警告",
      filterLogs: "ログ",
      searchPlaceholder: "メッセージを絞り込み...",
      clearConsole: "コンソールをクリア",
      emptyNoMessages: "コンソールメッセージはまだありません。",
      emptyNoMatch: "フィルターに一致するメッセージはありません。",
      warnLevelIcon: "⚠️",
      logLevelDefaultIcon: "›",
      viewStackTrace: "スタックトレースを表示",
      openSourceTitle: "{file} を開く",
      copyErrorPromptTitle: "このエラーを AI で解決するための完全なプロンプトをコピー",
      copiedExclaim: "コピーしました！",
      resolveWithAi: "AI で解決",
      tabConsole: "コンソール",
      tabNetwork: "ネットワーク",
      emptyNetwork: "ネットワークリクエストはまだありません。",
      clearNetwork: "ネットワークログをクリア",
    },
    viewport: {
      selectDeviceTitle: "デバイスまたは解像度を選択",
      responsiveLabel: "100% レスポンシブ",
      customSizeLabel: "{width}×{height}",
      responsiveFullLabel: "100% レスポンシブ（フルード）",
      categoryMobile: "📱 スマートフォン",
      categoryTabletLaptop: "💻 タブレットとノート PC",
      categoryDesktop: "🖥️ デスクトップ",
      orientationToPortrait: "縦向きに切り替え",
      orientationToLandscape: "横向きに切り替え",
      hideDeviceFrame: "デバイスフレームを隠す",
      showDeviceFrame: "フレームを表示",
      zoomScaleTitle: "ズーム倍率",
    },
  },
  ssh: {
    dialog: {
      extraArgsHint: "OpenSSH -o とフラグ",
      extraArgsPlaceholder: "-o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -o HostKeyAlias=myhost -o LogLevel=ERROR",
      extraArgsDescription: "追加の SSH フラグと OpenSSH -o オプション（Docker コンテナ、プロキシ、カスタムキーなど）。",
      quickPresets: "クイックオプション:",
      presetBypassHostKey: "ホスト確認を省略",
      presetHostKeyAlias: "HostKeyAlias",
      presetLogLevelError: "静かに（LogLevel ERROR）",
      presetForwardAgent: "エージェント転送（-A）",
      presetCompression: "圧縮（-C）",
    },
  },
  onboarding: {
    getStarted: "始める",
    getProviderKey: "{provider} の API キーを取得",
  },
  apiClient: {
    header: {
      toggleCollectionsSidebar: "コレクションサイドバーの表示切替",
      environment: "環境",
      environments: "環境",
      active: "アクティブ",
    },
    discovery: {
      knownEndpoint: "既知のエンドポイント: {path}",
      probeEndpoint: "エンドポイント探査: {path}",
      defaultCollectionDescription: "環境付きの Pokémon REST / SSE / GraphQL API カタログ",
      importedCollectionDescription: "{count} 件のエンドポイントをインポートしました",
    },
    collections: {
      title: "コレクション",
      deleteCollection: "コレクションを削除",
      newCollection: "新しいコレクション...",
      addRequestOrFolder: "リクエストまたはフォルダーを追加",
      newRequest: "新しいリクエスト",
      newFolder: "新しいフォルダー",
      collectionNamePlaceholder: "コレクション名...",
      folderNamePlaceholder: "フォルダー名（例: Auth、REST）...",
      save: "保存",
      add: "追加",
      filterRequestsPlaceholder: "リクエストを絞り込み...",
      deleteFolder: "フォルダーを削除",
      deleteRequest: "リクエストを削除",
    },
    request: {
      invalidCurlCommand: "無効な cURL コマンドです",
      curlImported: "cURL コマンドをインポートしました！",
      noValidPostmanRequests: "Postman JSON に有効なリクエストがありません",
      postmanImported: "コレクション \"{name}\" から {count} 件のリクエストをインポートしました",
      postmanImportFailed: "Postman コレクションを解析できませんでした",
      urlPlaceholder: "https://api.example.com/v1/resource",
      sending: "送信中...",
      send: "送信",
      discoverTitle: "このベース URL からルートを自動検出",
      discover: "検出",
      importCurl: "cURL をインポート",
      importPostman: "Postman コレクションをインポート",
      importCurlCommand: "cURL コマンドからインポート:",
      curlPlaceholder: "cURL コマンドをここに貼り付け...",
      cancel: "キャンセル",
      import: "インポート",
      importPostmanJson: "Postman コレクション JSON をインポート（v2.0 / v2.1）:",
      postmanPlaceholder: "Postman から書き出した collection.json をここに貼り付け...",
      ...
      addParam: "パラメーターを追加",
      noQueryParameters: "クエリパラメーターはありません。「パラメーターを追加」で URL に追加できます。",
      key: "キー",
      value: "値",
      ...
      apiKey: "API キー",
      basicAuth: "Basic 認証",
      oauth2Token: "OAuth 2.0 トークン",
      awsSignatureV4: "AWS Signature V4",
      digestAuth: "Digest 認証",
      token: "トークン:",
      accessToken: "アクセストークン:",
      tokenPrefix: "トークン接頭辞（任意）:",
      accessKeyId: "アクセスキー ID:",
      secretAccessKey: "シークレットアクセスキー:",
      secretKeyPlaceholder: "シークレットキー",
      awsRegion: "AWS リージョン:",
      awsService: "AWS サービス:",
      username: "ユーザー名:",
      password: "パスワード:",
      ...
      none: "なし",
      text: "テキスト（text/plain）",
      formUrlEncoded: "フォーム URL エンコード",
      javascriptFetch: "JavaScript fetch",
      snippetCopied: "スニペットをクリップボードにコピーしました！",
      copy: "コピー",
      variables: "変数",
      variablesCount: "{count} 個の変数",
    },
    response: {
      executing: "ネイティブ Rust エンジンでリクエストを実行中...",
      cancelRequest: "リクエストをキャンセル",
      noResponse: "まだ応答がありません",
      emptyDescription: "URL を入力し、送信をクリックするか {shortcut} を押して API 出力を確認します。",
      copied: "応答をクリップボードにコピーしました",
      networkError: "ネットワークエラー",
      diagnoseWithAi: "AI で診断",
      investigateWithAi: "AI で調査",
      copyResponse: "応答をコピー",
      body: "ボディ",
      headers: "ヘッダー（{count}）",
      timings: "タイミング",
      pretty: "整形",
      raw: "生データ",
      networkPhaseBreakdown: "ネットワーク段階の内訳",
      ttfbTooltip: "TTFB: {value}ms",
      contentDownloadTooltip: "コンテンツダウンロード: {value}ms",
      ttfbServerProcessing: "TTFB（サーバー処理）",
      contentDownload: "コンテンツダウンロード",
      timeToFirstByte: "最初のバイトまでの時間（TTFB）:",
      notAvailable: "N/A",
      contentDownloadDuration: "コンテンツダウンロード時間:",
      totalRoundtripLatency: "往復レイテンシ合計:",
      payloadSize: "ペイロードサイズ:",
      bytes: "バイト",
      transportEngine: "トランスポートエンジン:",
      nativeEngine: "ネイティブ Rust 非同期エンジン（CORS 制限なし）",
    },
    sandbox: {
      receiptCopied: "検証レシートをクリップボードにコピーしました！",
      title: "サンドボックス Webhook と冪等性プローブ",
      simulator: "クォータなしシミュレーター",
      selectPreset: "プロバイダーのプリセットを選択:",
      localWebhookUrl: "ローカル Webhook URL:",
      signingSecret: "署名シークレット（Stripe-Signature / X-Hub-Signature-256 を自動生成）:",
      deliveryMode: "プローブ配信モード:",
      singleDelivery: "単一配信（1x）",
      singleDeliveryDescription: "標準の Webhook イベント送信",
      idempotencyProbe: "冪等性プローブ（3x）",
      idempotencyProbeDescription: "重複 Webhook の除外をテストします",
      payload: "ペイロード（JSON）:",
      dispatching: "送信中...",
      dispatch: "Webhook プローブを送信",
      results: "プローブ結果と診断",
      copyReceipt: "検証レシートをコピー（.md）",
      ready: "サンドボックスプローブを送信する準備ができました",
      emptyDescription: "「Webhook プローブを送信」をクリックして、署名付きペイロードと重複バーストでローカルエンドポイントをテストします。",
      passed: "冪等性プローブに合格",
      failed: "プローブ失敗 / エラー",
      verified: "検証済み",
      fixNeeded: "修正が必要",
      fixWithAi: "AI エージェントで Webhook ハンドラーを修正",
      deliveryAttempts: "配信試行:",
      attempt: "試行 #{count}",
      presets: {
        stripePaymentIntentSucceeded: "Stripe: Payment intent 成功",
        stripeChargeFailed: "Stripe: 課金失敗（カード拒否）",
        stripeChargeRefunded: "Stripe: 課金返金",
        githubPush: "GitHub: Push イベント",
        supabaseUserCreated: "Supabase: Auth ユーザー作成",
        resendEmailDelivered: "Resend: メール配信済み",
      },
    },
    scenarios: {
      receiptCopied: "検証レシートをクリップボードにコピーしました！",
      title: "統合シナリオとワークフロー",
      sequentialSteps: "{count} 個の連続ステップ",
      steps: "シナリオのステップ:",
      kind: "種類: {kind}",
      running: "シナリオを実行中...",
      run: "シナリオを実行",
      receipt: "実行レシート",
      copyReceipt: "レシートをコピー（.md）",
      noScenario: "まだシナリオは実行されていません",
      emptyDescription: "シナリオを実行して、統合の確定的な前後検証レシートを生成します。",
      passed: "シナリオ合格（検証済み）",
      failed: "シナリオ失敗（修正が必要）",
      passedCount: "合格",
      completedIn: "{duration} ms で完了",
      diagnostics: "ステップ診断:",
      stepPassed: "合格",
      stepFailed: "失敗",
      presets: {
        stripeFullCycle: {
          title: "Stripe のフルチェックアウトと冪等性",
          description: "エンドツーエンドの支払い Webhook テストの後に、重複の冪等性プローブを実行します。",
          dispatchPayment: "1. payment_intent.succeeded を送信",
          idempotencyBurst: "2. 冪等性プローブ（3 回の重複バースト）",
        },
      },
    },
  },
...
const jaGapFill: DeepPartial<TranslationSchema> = {
  common: {
  ...
  themes: {
    descriptions: {
      vokttyDefault: {
        default: "控えめなアクリルの透明感と調整された色を備えた、モダンな Obsidian スタジオ。",
        fluent: "Carbon の奥行きと清潔な面で構成した Windows Fluent Desktop テーマ。",
        liquid: "適応型のガラスナビゲーションと、集中しやすい無地の作業面。",
        nord: "北極を思わせる北欧ブルーのパレット。",
        dracula: "クラシックな高コントラストのパープルダークテーマ。",
        "tokyo-night": "落ち着いた青みのダークテーマ。",
        catppuccin: "Mocha と Latte、心地よいパステル。",
        "rose-pine": "Soho の雰囲気。天然のパインとローズ。",
        everforest: "柔らかく低コントラストの緑の森パレット。",
        gruvbox: "暖かく土っぽいレトロパレット。",
        solarized: "Ethan Schoonover による、まぶしさを抑えた精密パレット。",
        kanagawa: "北斎に着想した墨色のダークと、暖かい Lotus ライト。",
        "kanagawa-dragon": "Kanagawa の Dragon バリアント。落ち着いたほぼ黒。",
        claude: "紙の上に暖かいクレイのアクセント。",
        xcode: "systemBlue アクセントの Apple システムカラー。",
        tide: "深海のスレートに、海のような発光ネオーンティール。",
        sage: "落ち着いたフォレストグリーン。静かで柔らかい。",
        caffeine: "暖かいコーヒートーン、クリームとエスプレッソ。",
      },
    },
  },
  settings: {
    tabs: {
      companion: "モバイル Companion",
    },
    companion: {
      title: "モバイル Companion",
      description: "承認済みの Android Companion と、アクティブなエージェント会話だけを共有します。",
      scopeTitle: "エージェントのみのアクセス",
      scopeDescription: "Companion はターミナル、SSH、ファイル、エディター、Git、デスクトップ操作を公開しません。",
      start: "Companion を開始",
      stop: "Companion を停止",
      starting: "セキュアトンネルを開始しています...",
      active: "ペアリングの準備完了",
      inactive: "Companion はオフです",
      copyPayload: "ペアリング用ペイロードをコピー",
      expires: "ペアリングの有効期限: {{time}}",
      tunnel: "一時的な Cloudflare トンネル",
      qrCode: "このペアリング QR コードを Voktty の Android Companion でスキャンしてください",
      generatingQr: "ペアリング QR コードを生成しています...",
      error: "Companion を開始できませんでした: {{message}}",
      pendingTitle: "ペアリングリクエスト",
      fingerprint: "フィンガープリント: {{fingerprint}}",
      approve: "承認",
      reject: "拒否",
    },
    models: {
      localAgent: "ローカルエージェント",
      localAgentDescription: "選択したインストール済み CLI と、既存のローカル OAuth セッションを使用します。API キーは Voktty にコピーされません。",
      modelDescriptions: {
        claude_fable_5_1: "自律的なエージェントコーディングと深い推論向けの、Anthropic 最新 Mythos クラスモデル。",
        gemini_3_8_flash: "動的思考を備えた、Google 最新の高速マルチモーダルフラッグシップ。",
        gemini_3_7_flash: "動的思考を備えた、Google の高速マルチモーダルフラッグシップ。",
        gemini_3_6_flash: "高知能で非常に高速なマルチモーダル推論モデル。",
        gemini_3_1_pro: "深い推論、1M コンテキスト、強力なコーディング。",
        harness_claude: "ローカルの Claude CLI と OAuth セッション経由で実行します。",
        harness_codex: "ローカルの Codex CLI と OAuth セッション経由で実行します。",
        harness_agy: "ローカルの Agy / Cursor エージェントと OAuth セッション経由で実行します。",
        harness_opencode: "ローカルの OpenCode エージェント経由で実行します。",
        harness_grok: "ローカルの Grok CLI と OAuth セッション経由で実行します。",
      },
    },
  },
  companion: {
    mobile: {
      title: "モバイル Companion",
      description: "このスマートフォンを承認済みの Voktty デスクトップに接続し、アクティブなエージェント会話をフォローします。",
      agentOnlyTitle: "エージェント会話のみ",
      agentOnlyDescription: "このアプリはデスクトップのワークベンチ、ターミナル、SSH セッション、ファイル、エディターを開きません。",
      waitingForPairing: "デスクトップとのペアリングはここで利用できるようになります。",
      payloadLabel: "ペアリング用ペイロード",
      payloadPlaceholder: "デスクトップのペアリング用ペイロードを貼り付けてください",
      connect: "ペアリングをリクエスト",
      connecting: "ペアリングをリクエストしています...",
      waitingForApproval: "デスクトップでの承認を待っています。",
      paired: "ペアリングに成功しました。デスクトップがアクティブなエージェントをここに表示します。",
      connectionError: "ペアリングリクエストを送信できませんでした。ペイロードとトンネルを確認してください。",
      scanQr: "ペアリング QR コードをスキャン",
      stopScanning: "スキャンを停止",
      cameraError: "カメラにアクセスできません。代わりにペアリング用ペイロードを貼り付けてください。",
    },
  },
  tabs: {
    newBrowser: "新しい Web ブラウザー",
    splitRight: "ターミナルを右に分割",
    splitDown: "ターミナルを下に分割",
    splitPreview: "分割ビューでプレビューを開く",
    splitGitGraph: "分割ビューでコミットグラフを開く",
    splitEditor: "分割ビューで新しいエディター",
    duplicateSplit: "分割ビューで複製",
  },
  git: {
    githubReviewTitle: "GitHub Pull Request をレビュー",
    githubReviewDescription: "GitHub アカウントを接続すると、Voktty を離れずに pull request の一覧表示、閲覧、レビューができます。",
    githubReviewScope: "リポジトリ: {repo}",
    githubConnectHelp: "repo スコープの personal access token を貼り付けてください。OS のキーチェーンに保存され、api.github.com 以外には送信されません。",
    githubCreateToken: "GitHub でトークンを作成",
    githubConnect: "接続",
    githubDisconnect: "切断",
    githubOpenPrs: "オープンな pull request {count} 件",
    githubNoOpenPrs: "オープンな pull request はありません",
    githubNoRemote: "このリポジトリには GitHub リモートがありません",
    githubDiffTruncated: "diff は切り詰められました",
    githubReviewBodyPlaceholder: "コメントを追加（変更リクエストには必須）...",
    githubReviewBodyRequired: "変更が必要な内容を説明するコメントを追加してください",
    githubComment: "コメント",
    githubRequestChanges: "変更をリクエスト",
    githubApprove: "承認",
    githubReviewSubmitted: "レビューを GitHub に送信しました",
  },
  connectionsLaunchpad: {
    title: "接続",
    placeholder: "アクティブおよび利用可能な接続を検索...",
    active: "アクティブな接続",
    available: "利用可能な接続",
    noResults: "検索に一致する接続はありません",
    newSsh: "新しい SSH",
    newRdp: "新しい RDP",
    newSerial: "新しいシリアル",
    joinCompanion: "Companion に参加",
    running: "実行中",
    current: "現在の接続",
    hintNavigate: "上下で移動",
    hintOpen: "Enter で開く",
  ...
  commandPalette: {
    commands: {
      copyPerfSnapshot: "パフォーマンススナップショットをコピー",
      copyPerfSnapshotDone: "パフォーマンススナップショットをクリップボードにコピーしました",
      copyPerfSnapshotFailed: "パフォーマンススナップショットをコピーできませんでした",
    },
  },
  shortcuts: {
    labels: {
      connectionsLaunchpad: "接続を開く",
    },
  },
  launcher: {
    items: {
  ...
  preview: {
    whatAreWeDebuggingToday: "今日は何をデバッグしますか？",
    enterUrlOrSearch: "URL または検索語句を入力して、閲覧と検査を開始します。",
    urlOrSearchPlaceholder: "URL（例: localhost:3000）または検索を入力...",
    noActivePreview: "アクティブなプレビュータブがありません。先に localhost のプレビューを開いてください。",
    noLiveComponent: "ブラウザーで選択中のコンポーネントはありません。Ctrl+G で検査を切り替え、要素をクリックしてください。",
    navigationLocalhostOnly: "プレビューのナビゲーションは localhost URL に制限されています。外部 URL はアドレスバーに貼り付けてください。",
    inspectElement: "要素を検査 (AI)",
    elementSelected: "要素を選択しました",
    copyReferenceMenu: "参照をコピー (@component)",
    referenceCopied: "参照をコピーしました",
    copyDebugPromptMenu: "デバッグ用プロンプトをコピー",
    debugPromptCopied: "デバッグ用プロンプトをコピーしました",
    copyModifyPromptMenu: "修正用プロンプトをコピー",
    modifyPromptCopied: "修正用プロンプトをコピーしました",
    copyCssSelector: "CSS セレクターをコピー",
    copyHtmlSnippet: "HTML スニペットをコピー",
    htmlCopied: "HTML をコピーしました",
    reloadPreview: "プレビューを再読み込み",
    nativeMenuHint: "Shift + 右クリックでネイティブメニュー",
    copyError: "コピーに失敗しました",
    closeInspector: "インスペクターを閉じる",
  },
  terminal: {
    gitChanges: "{count, plural, =1 {件の変更} other {件の変更}}",
    gitDiffHudTooltip: "フローティングのライブ Git レビューを開く（{count} {count, plural, =1 {件の変更} other {件の変更}}） · Alt+D",
  },
  agentHistory: {
    productName: "Wake",
    productVersion: "v1.0",
    sessionStats: "{sessions} セッション · {messages} メッセージ",
    searchSessions: "セッションを検索",
    searchShortcut: "⌘K",
    searchSessionsCount: "{count} 件のセッションを検索...",
    searchShortcutPlaceholder: "検索 (Ctrl+K)...",
    allSessions: "すべてのセッション",
    starred: "スター付き",
    starredSessions: "スター付きセッション",
    dateUpdated: "更新日",
    loadingSessions: "セッションを読み込み中...",
    agentsLabel: "エージェント",
    ...
    agent: "エージェント",
    resume: "再開",
    copyTranscriptMarkdown: "トランスクリプトを Markdown でコピー",
    user: "ユーザー",
    toolExecution: "ツール実行",
    assistant: "アシスタント",
    redacted: "伏字",
    thinkingProcess: "思考プロセス",
    selectSessionTranscript: "一覧からセッションを選ぶと、完全なトランスクリプトを表示します",
    noResultsFor: "「{query}」に一致する結果はありません",
    scopeAllSessions: "範囲: すべてのセッション",
    navigate: "移動",
    open: "開く",
    close: "閉じる",
    escapeKey: "esc",
    cannotResume: "このセッションを再開するコマンドはありません。",
    copyMessageText: "メッセージテキストをコピー",
    harnessExecutionError: "ローカル {agent} エージェントの実行エラー: {error}。CLI '{binary}' がインストール済みでログインしていることを確認してください。",
    harnessWorkspaceRequired: "ローカル OAuth エージェントを使う前に、ローカルワークスペースを開いてください。",
    noActiveTerminal: "このセッションを再開する前にターミナルを開いてください。",
    noSessionSelected: "セッションが選択されていません",
    resumeCommandCopied: "再開コマンドをクリップボードにコピーしました",
    resumingSession: "ターミナルで {agent} セッションを再開しています",
    selectSessionDetail: "セッションを選ぶとトランスクリプトを表示します。",
    textCopied: "テキストをクリップボードにコピーしました",
    transcriptCopied: "トランスクリプトをクリップボードにコピーしました",
    agents: {
      opencode: "OpenCode",
      grok: "Grok Build",
    },
  ...
  notesBoard: {
    ...
    maximize: "最大化",
    workspace: "ワークスペース",
    centerWindow: "ウィンドウを中央へ",
    regionLabel: "フローティングノートと Kanban ボード",
    tabNotes: "ノートとアイデア",
    tabKanban: "Kanban",
    tabReview: "Git レビュー",
    dragToMove: "ドラッグして移動 · ダブルクリックでドッキングまたは解除",
    dockBelow: "下にドッキング（ダブルクリック）",
    undockWindow: "自由ウィンドウとして解除（ダブルクリック）",
    closeEsc: "閉じる (Esc)",
    footerHint: "Voktty Workspace Hub · 上部バーをドラッグして移動",
    newNoteShortcut: "Alt+N: 新しいノート",
    newReviewShortcut: "Alt+D: Git レビュー",
    escToClose: "Esc で閉じる",
    liveDiff: "ライブ Diff",
    renamedFrom: "(← {path})",
    staged: "ステージ済み",
    ...
    unstageAll: "すべてのステージを解除",
    discardAll: "すべて破棄",
    discardAllConfirm: "未コミットの変更をすべて破棄しますか？",
    discardAllDesc: "この操作は取り消せません。作業ツリー内の変更済みファイルはすべて元に戻されます。",
    discardFile: "変更を破棄",
    discardFileConfirm: "'{file}' の変更を破棄しますか？",
    discardFileDesc: "このファイルの未コミットの編集が元に戻されます。",
    filterFiles: "変更ファイルを絞り込む...",
    noChangesTitle: "作業ツリーはクリーンです",
    noChangesDesc: "現在のリポジトリに変更ファイルは検出されませんでした。",
    noRepoTitle: "Git リポジトリが見つかりません",
    noRepoDesc: "アクティブなワークスペースフォルダーは Git リポジトリではありません。",
    walkthroughAi: "AI ウォークスルー",
    githubPrReview: "GitHub PR",
    sendReviewToAgent: "レビューをエージェント / ターミナルに送信",
    prevFile: "前のファイル",
    nextFile: "次のファイル",
    markReviewed: "確認済みにする",
    unmarkReviewed: "確認済みを解除",
    columns: {
      ideas: "アイデア",
      ideasDesc: "下書き、構想、簡単なメモ",
      todo: "未着手",
      todoDesc: "計画済みおよび未着手のタスク",
      inProgress: "進行中",
      inProgressDesc: "開発中、またはエージェントが実行中のタスク",
      done: "完了",
      doneDesc: "完了して確認済みのタスク",
    },
    priority: {
      low: "低",
      medium: "中",
    ...
    observing: "監視中",
    observe: "監視",
    observingOn: "監視はオンです: エージェント完了時に Voktty が状態を同期しカードを進めます（クリックで一時停止）",
    observingOff: "監視は一時停止中です: Voktty はプロセスを追跡していません（クリックで再開）",
    cardsCount: "{count} 枚のカード",
    agentsReady: "{count} 個のエージェント準備完了",
    exportVault: "エクスポート",
    importVault: "インポート",
    exportVaultTitle: "カードを .voktty/tasks/ にエクスポート (Git)",
    importVaultTitle: ".voktty/tasks/ からカードをインポート (Git)",
    exportedToast: "{count} 枚のカードを .voktty/tasks/ にエクスポートしました",
    exportError: "カードを保管庫へエクスポートできませんでした",
    importedToast: ".voktty/tasks/ から {count} 枚のカードを同期しました",
    importEmpty: ".voktty/tasks/ にカードが見つかりません",
    importError: "保管庫からカードをインポートできませんでした",
    newCard: "新しいカード",
    taskTitlePlaceholder: "タスクのタイトル...",
    taskDescPlaceholder: "説明（チェックリスト対応 - [ ]）",
    emptyColumn: "カードなし",
    untitledTask: "無題のタスク",
    untitledNote: "無題のノート",
    newNote: "新しいノート",
    noteFallback: "ノート",
    advanceColumn: "次の列へ移動",
    deleteCard: "カードを削除",
    codePlaceholder: "[code]",
    needsConsole: "コンソールでの対応が必要です",
    needsConsoleTitle: "コンソールでの介入が必要です。クリックしてターミナルにフォーカス",
    terminalClosedEarly: "完了前にターミナルが閉じられました",
    assignedTo: "{agent} に割り当て済み（タブ {tabId}）。クリックしてフォーカス",
    unassignAgent: "エージェントの割り当てを解除",
    runWithAgent: "エージェントで実行...",
    agent: "エージェント",
    sendTaskToAgent: "タスクをエージェントに送信",
    noActiveTerminals: "アクティブなターミナルはありません",
    runInTerminal: "ターミナルに貼り付けて実行: {command}",
    run: "実行",
    filterNotes: "ノートを絞り込む...",
    createNoteTitle: "新しいノートを作成して保存 (Alt+N)",
    noNotes: "ノートはまだありません",
    emptyNote: "空のノート",
    noteTitlePlaceholder: "ノートのタイトルまたはコマンド...",
    sendToAgent: "エージェントに送信",
    sendToAgentTitle: "ノートまたはコマンドをアクティブな CLI エージェントに送信",
    sendToAgentOrTerminal: "アクティブなエージェントまたはターミナルに送信",
    noActiveAgents: "アクティブなターミナルまたはエージェントはありません",
    commandOnly: "検出されたコマンドのみ:",
    commandOnTab: "{tab} 上",
    toKanban: "Kanban へ",
    toKanbanTitle: "このノートを Kanban カードにする",
    runInTerminalTitle: "ターミナルで実行: {command}",
    copyText: "テキストをコピー",
    deleteNote: "ノートを削除",
    noteBodyPlaceholder: "Markdown のノート、コマンド、アイデアを書く...",
    selectOrCreateNote: "左からノートを選ぶか、新しく作成してください",
    sentTo: "{name}（{tab}）に送信しました",
    tabFallback: "タブ {id}",
    taskPrompt: "タスク: {title}",
    taskPromptWithDetails: "タスク: {title}\n\n詳細:\n{details}",
  },
  harness: {
    promptOutline: "プロンプトの概要",
    promptPreview: "プロンプトのプレビュー",
    reminders: {
      dueReminders: "期限のリマインダー",
      loadError: "リマインダーを読み込めませんでした。",
      openSession: "セッションを開く",
      snooze: "スヌーズ",
      dismiss: "閉じる",
      desktopAlertsOff: "デスクトップ通知はオフです。設定で有効にしてください。",
      reminder: "リマインダー",
    },
    notes: {
      tags: "タグ",
      removeTag: "#{tag} を削除",
      addNoteTag: "ノートのタグを追加",
      addTagPlaceholder: "タグを追加…",
    },
    broadcast: {
      title: "すべてのエージェントに送信",
      description: "Voktty で開いているすべてのエージェントセッションに同じメッセージを送ります。送信前にスキップしたいセッションのチェックを外してください。",
      noSessions: "開いているエージェントセッションはありません。",
      placeholder: "選択したエージェントに送るメッセージ...",
      send: "{count} 個のエージェントに送信",
      resultAllSent: "{count} 個のエージェントに送信しました",
      resultPartial: "{sent} 個のエージェントに送信、{failed} 個は失敗",
    },
    settings: {
      title: "Agent Harness",
      description: "Agent Harness セッションペインの動作、外観、AI プロバイダー設定。",
      inboxDesc: "受信トレイのフィード用ソース接続とトークンを管理します。",
      github: "GitHub",
      githubConnection: "GitHub 接続",
      githubConnected: "GitHub CLI 経由で接続済み",
      githubConnectedDesc: "Voktty は認証済みの gh セッション経由で Issue とレビューリクエストを読み取ります。",
      githubSignInRequired: "サインインが必要です",
      githubSignInRequiredDesc: "GitHub CLI はインストールされていますが、サインインしていません。ターミナルで 'gh auth login' を実行してください。",
      githubNotInstalled: "GitHub CLI が見つかりません",
      githubNotInstalledDesc: "gh CLI をインストールし、'gh auth login' を実行すると、通知、Issue、pull request を受信トレイに取り込めます。",
      githubInstallGuide: "GitHub CLI をインストール",
      githubCheckAgain: "接続を確認",
      githubChecking: "GitHub CLI を確認しています...",
      workspaceLayout: "ワークスペースのレイアウト",
      workspaceLayoutDesc: "Classic はサイドバーを 1 本にします。Deck はプロジェクトレール、ワークスペースパネル、ターミナルドックを追加します。",
      deck: "Deck",
      classic: "Classic",
      transcriptLayout: "トランスクリプトのレイアウト",
      transcriptLayoutDesc: "全幅ではプロンプトを横断カードのままにします。チャットでは右寄せにします。",
      fullWidth: "全幅",
      anchorPrompts: "プロンプトを上部に固定",
      anchorPromptsDesc: "新しいプロンプトはトランスクリプトの上部に置き、返信はその下に伸びます。",
      zenMode: "Zen モード",
      zenModeDesc: "エージェントの作業を折りたたみ可能なグループとして表示します。{shortcut} で切り替えます。",
      composerMascot: "コンポーザーのマスコット",
      composerMascotDesc: "ターン実行中、プロジェクトのマスコットがコンポーザー上を走ります。",
      emptySessionGames: "空セッションのゲーム",
      emptySessionGamesDesc: "空セッションのグリッドで Pac-man と snake が待機します。マウスを重ねると操作できます。",
      notes: "ノート",
      notesDesc: "プロジェクトレール上のグローバル Markdown ノート。",
      workingAgents: "作業中のエージェント",
      workingAgentsDesc: "複数のチャットが進行中のとき、レール上のカードに一覧表示します。",
      sounds: "サウンド",
      soundsDesc: "ターン完了時や受信トレイの新規アイテム時に短い合図を鳴らします。",
      claudeHooks: "Claude Code フック",
      claudeHooksDesc: "settings.json のフック（PreToolUse、ブロック、通知）を実行します。次のターンから有効です。",
      closeToTray: "システムトレイに閉じる",
      closeToTrayDesc: "ウィンドウを閉じても Voktty はシステムトレイで動き続け、バックグラウンドタスクが継続します。",
      restoreDefaults: "デフォルトに戻す",
      sidebarOpacity: "サイドバーの不透明度",
      sidebarOpacityDesc: "サイドバー越しにデスクトップがどれだけ見えるか。",
      blurRadius: "ぼかし半径",
      blurRadiusDesc: "ウィンドウ背後の背景ぼかし。",
      hue: "色相",
      hueDesc: "アクセントと着色面の基本色相。",
      saturation: "彩度",
      saturationDesc: "色相がインターフェースをどれだけ染めるか。",
      mainPaneGlass: "メインペインのガラス",
      mainPaneGlassDesc: "半透明の処理をセッション背後のメインペインにも広げます。",
      defaultBadge: "デフォルト",
      useByDefault: "デフォルトで使用",
      showInPicker: "ピッカーに表示",
      showInPickerAria: "{name} をピッカーに表示",
      modelAria: "{name} モデル",
      modelsAvailable: "{count, plural, one {# 個のモデルが利用可能です。} other {# 個のモデルが利用可能です。}}",
      providersIntro: "CLI が PATH で見つかると、プロバイダーはインストール済みとして表示されます。各プロバイダー横のモデルは新しいセッションで使われます。",
    },
    modelSettings: {
      reasoning: "推論",
      serviceTier: "サービス階層",
    ...
    addToChat: "チャットに追加",
    addToNotes: "ノートに追加",
    selectedTextActions: "選択テキストの操作",
    unavailableDir: "ディスク上にディレクトリがありません",
    unavailableDirShort: "ディレクトリが利用できません",
    unavailableDirTag: "[ディスク上にディレクトリがありません]",
    working: "作業中",
    menu: {
      file: "ファイル",
      view: "表示",
      ...
      checkForUpdates: "アップデートを確認...",
      toggleSidebar: "サイドバーの切り替え",
      toggleZen: "Zen モードの切り替え",
      inbox: "受信トレイ",
      notes: "ノート",
      toggleTerminal: "ターミナルの切り替え",
      switchModel: "モデルを切り替え...",
      toggleChanges: "変更の切り替え",
    },
    chrome: {
      toolExecution: "ツール実行",
      cancelReminder: "リマインダーをキャンセル",
      multipleReminderTimes: "複数のリマインダー時刻",
      remindMe: "リマインドする",
      reminders: "リマインダー",
      showDetails: "詳細を表示",
      hideDetails: "詳細を隠す",
      ...
      chooseChatBackground: "チャットの背景を選択",
      chooseProjectChatBackground: "プロジェクトチャットの背景を選択",
      chooseProjectLogo: "プロジェクトロゴを選択",
      updateInstallPrompt: "MonoCode {available} が利用可能です（現在は {current}）。{detail}\n\n今すぐインストールしますか？",
      updatesUnavailable: "このビルドでは自動アップデートが設定されていません。\n\nリリースは https://github.com/hardbeat920/monocode/releases/latest からダウンロードしてください",
      updateCheckError: "アップデートを確認できませんでした。\n\n{error}",
      checkingForUpdates: "アップデートを確認しています…",
      latestVersion: "最新バージョンを使用しています。",
      updateCheckFailed: "アップデートの確認に失敗しました。",
      updatesFromReleaseFeed: "Voktty はリリースフィードから自動更新されます。",
      checkForUpdates: "アップデートを確認",
      download: "ダウンロード",
      chatBackground: "チャットの背景",
      chatBackgroundDesc: "チャットペインの背後に表示する画像です。このデバイスに保存されます。",
      change: "変更",
      previewAt: "{visibility}% でプレビュー",
      bindingCount: "{count, plural, one {# 件のバインド} other {# 件のバインド}}",
      keybindingsDesc: "バインドはアプリメニューとワークスペースのキーハンドラーから来ます。まだカスタマイズできません。",
      providersIntroLong: "CLI が PATH で見つかると、プロバイダーはインストール済みとして表示されます。未インストールの CLI もここに残りますが、モデルピッカーからは除外されます。「ピッカーに表示」をオフにすると、インストール済みプロバイダーをそれらのタブから隠せます。各プロバイダー横のモデルは、そのプロバイダー選択時の新しい会話で使われます。「デフォルトで使用」はそのプロバイダー自体を選びます。",
      archiveProjectHint: "レールからプロジェクトをアーカイブすると、チャットは残しつつサイドバーには表示しません。",
      openProjectForArchived: "プロジェクトを開くと、アーカイブ済みの会話を表示できます。",
      noArchivedConversations: "このプロジェクトにアーカイブ済みの会話はありません。",
      commit: "コミット",
      commitAndPush: "コミットしてプッシュ",
      commitPushCreatePr: "コミット、プッシュ、PR 作成",
      noUncommittedChanges: "未コミットの変更はありません",
      loadingChanges: "変更を読み込み中…",
      unstageAllChanges: "すべての変更のステージを解除",
      stageAllChanges: "すべての変更をステージ",
      divergedFrom: "{upstream} から分岐",
      unpushedCommitCount: "{count, plural, one {# 件の未プッシュコミット} other {# 件の未プッシュコミット}}",
      incomingCommitCount: "{count, plural, one {# 件の受信コミット} other {# 件の受信コミット}}",
      noFiles: "ファイルなし",
      synchronizingChanges: "変更を同期しています…",
      publishBranch: "ブランチを発行",
      publishBranchNamed: "ブランチ \"{branch}\" を発行",
      pullAndPushCommits: "{dest} の間で {behind} 件をプルし {ahead} 件をプッシュ",
      pullCommits: "{dest} から {count, plural, one {# 件のコミット} other {# 件のコミット}}をプル",
      pushCommits: "{dest} へ {count, plural, one {# 件のコミット} other {# 件のコミット}}をプッシュ",
      syncChanges: "変更を同期",
      createPr: "PR を作成",
      createPrInto: "{branch} への pull request を作成",
      viewPr: "PR を表示",
      viewPrNumber: "PR #{number} を表示",
      viewPrDetails: "PR #{number} を表示: {title}",
      deleteProjectNamed: "{name} を削除",
      deleteProjectNamedQuestion: "「{name}」を削除しますか？",
      deleteProjectDescription: "このプロジェクトの会話はすべて削除されます。サイドバーからも外れます。ディスク上のフォルダーはそのまま残り、再度開くと空のプロジェクトとして戻ります。",
      savedConversationRemoval: "{count, plural, one {# 件の保存済み会話が削除されます。} other {# 件の保存済み会話が削除されます。}}",
      networkSandboxAllowlistHint: "1 行に 1 ホスト。*. を付けると任意のサブドメインを許可します。それ以外には到達できません。",
      networkSandboxUnrestricted: "エージェントの送信ネットワークに制限はありません。",
      noMatchingFilesOrNotes: "一致するファイルまたはノートはありません",
      noMatchingFilesOrFolders: "一致するファイルまたはフォルダーはありません",
      noFilesOrNotesFound: "ファイルまたはノートが見つかりません",
      noFilesOrFoldersFound: "ファイルまたはフォルダーが見つかりません",
      filesAndNotes: "ファイルとノート",
      filesAndFolders: "ファイルとフォルダー",
      note: "ノート",
      fileCount: "{count, plural, one {# 個のファイル} other {# 個のファイル}}",
      workingTreeChanges: "作業ツリーの変更",
      sessionChanges: "セッションの変更",
      closeTabWithUnsavedFiles: "未保存のファイルがあるこのタブを閉じますか？",
      closeOtherTabsWithUnsavedFiles: "未保存のファイルがある他のタブを閉じますか？",
      closeFileWithoutSaving: "{name} を保存せずに閉じますか？",
      closeConversationWithUnsavedFiles: "未保存のファイルがあるこの会話を閉じますか？",
      deleteSessionNamed: "\"{name}\" を削除しますか？",
      deleteSelectedConversations: "選択した {count} 件の会話を削除しますか？この操作は取り消せません。",
      cannotFollowUpMidTurn: "{harness} はターンの途中でフォローアップを受け付けません。このターンの完了を待つか、先に停止してください。",
      manualCompactionUnsupported: "{harness} は手動のコンテキスト圧縮に対応していません。",
      compactingContext: "コンテキストを圧縮しています…",
      compactedContext: "コンテキストを圧縮しました",
      noProjectsFound: "プロジェクトが見つかりません",
      newProject: "新しいプロジェクト",
      switchProjectCurrent: "プロジェクトを切り替え、現在のプロジェクトは {name}",
      loadEarlierMessages: "以前のメッセージを読み込む",
      thinking: "思考中...",
      hidePrevious: "前を隠す",
      hidePreviousToolCalls: "前のツール呼び出しを隠す",
      hideFullNote: "ノート全文を隠す",
      thinkingLabel: "思考: {text}",
      agentSaid: "エージェント: {text}",
      toolCall: "ツール呼び出し: {text}",
      planNoLongerInSession: "このプランはセッションにありません。",
      providerNotConnected: "{harness} はまだ接続されていません。そのプロバイダーをインストールしてサインインしてから再試行してください。",
      errorWithMessage: "エラー: {message}",
      selectIssueOrPullRequest: "Issue または pull request を選択",
      unassigned: "未割り当て",
      updatedAt: "{time} に更新",
      noDescription: "説明なし",
      selectNote: "ノートを選択",
      ...
      release: "離す",
      takeControl: "操作する",
      unmodifiedLines: "{count} {count, plural, one {行が未変更} other {行が未変更}}",
      uncommittedSummary: "{label} 未コミット",
      toolCallWithState: "{state} のツール呼び出し: {text}",
      closePaneShortcut: "ペインを閉じる ({shortcut})",
      sessionChangesTooltip: "このセッションのみでキャプチャされた変更",
      plan: "プラン",
      workingTreeNamed: "{name}（作業ツリー）",
      tabProblems: "{title} · {count, plural, one {# 件の問題} other {# 件の問題}}",
      openFiles: "開いているファイル",
      loadingAgentHarness: "Agent Harness を読み込み中…",
      commentOn: "{location} にコメント",
      addCommentShortcut: "{shortcut}↩ で追加",
      fileNameRequired: "ファイルまたはフォルダー名を指定してください。",
      fileNameNoLeadingSlash: "ファイルまたはフォルダー名をスラッシュで始めることはできません。",
      fileNameExists: "この場所には {name} というファイルまたはフォルダーが既にあります。別の名前を選んでください。",
      fileNameInvalid: "{name} はファイルまたはフォルダー名として無効です。別の名前を選んでください。",
      fileNameWhitespace: "ファイルまたはフォルダー名の先頭または末尾に空白があります。",
      openContextActions: "{headline}、{detail}。コンテキストアクションを開く",
      ...
      savedToNotes: "ノートに保存しました",
      saveAsNote: "ノートとして保存",
      showPreviousToolCalls: "前のツール呼び出し {count} 件を表示",
      previousToolCalls: "+{count} {count, plural, one {件の前のツール呼び出し} other {件の前のツール呼び出し}}",
      hideWork: "作業を隠す",
      showWork: "作業を表示",
      hideStepsFor: "{title} のステップを隠す",
      showStepsFor: "{title} のステップを表示",
      hideThinking: "思考を隠す",
      showThinking: "思考を表示: {text}",
      modelWorked: "{model} が作業しました{ellipsis}",
      worked: "作業しました{ellipsis}",
      modelTurnWorking: "{model} が作業中{ellipsis}",
      turnWorking: "作業中{ellipsis}",
      modelWorkedFor: "{model} が {elapsed} 作業しました",
      workedFor: "{elapsed} 作業しました",
      modelTurnWorkingFor: "{model} が {elapsed} 作業中",
      turnWorkingFor: "{elapsed} 作業中",
      accepted: "承認済み",
      rejected: "却下済み",
      file: "ファイル",
      preparingHandoff: "ハンドオフを準備しています",
      preparingHandoffTo: "{harness} へのハンドオフを準備しています",
      continuedWith: "{harness} で続行しました",
      backShortcut: "戻る ({shortcut})",
      forwardShortcut: "進む ({shortcut})",
      toggleSidebarShortcut: "サイドバーの切り替え ({shortcut})",
      deleteGroupAndTabs: "「{name}」を削除して {count} 個のタブを閉じますか？",
      addToGroup: "{name} に追加",
      removeFromGroup: "グループから削除",
      couldntLoadSessions: "セッションを読み込めませんでした",
      couldntLoadSessionChanges: "セッションの変更を読み込めませんでした",
      noSessionChanges: "セッションの変更はありません",
      noFileChanges: "ファイルの変更はありません",
      diffTooLargeFull: "Diff が大きすぎて全体を表示できません。パッチなしでファイル一覧を表示します。",
      binaryFileChanged: "バイナリファイルが変更されました",
      diffTooLarge: "Diff が大きすぎて表示できません",
      noTextualDiff: "テキストの diff はありません",
      addProjectLogo: "プロジェクトロゴを追加",
      changeProjectLogo: "プロジェクトロゴを変更",
      projectLogo: "プロジェクトロゴ",
      projectLogoShown: "タブとコンポーザーに表示",
      projectLogoOptional: "任意。フォルダーアイコンの代わりに使います",
      mascot: "マスコット",
      mascotNamed: "マスコット {name}",
      unsavedChanges: "未保存の変更",
      closeTab: "タブを閉じる",
      inbox: "受信トレイ",
      notes: "ノート",
      send: "送信",
      stop: "停止",
      editQueued: "キュー内のメッセージを編集",
      saveQueued: "キュー内のメッセージを保存",
      cancelQueuedEdit: "キュー内メッセージの編集をキャンセル",
      removeQueued: "キュー内のメッセージを削除",
      attachFiles: "ファイルを添付",
      placeholderNote: "ノートを追加するか、送信して開始...",
      placeholderMessage: "メッセージを追加するか、送信...",
      placeholderContinue: "コンテキストを追加するか、送信して続行...",
      placeholderAskCommands: "質問、構築、/ でコマンド、@ で参照... ",
      placeholderAskSkills: "質問、構築、/ でスキル、@ で参照... ",
      jumpToLatest: "最新へ移動",
      closePane: "ペインを閉じる",
      resizeChanges: "変更ペインのサイズを変更",
      newTerminalTab: "新しいターミナルタブ",
      cancelComment: "コメントをキャンセル",
      leaveComment: "コメントを残す...",
      jumpBetweenChanges: "変更間を移動",
      previousChange: "前の変更",
      nextChange: "次の変更",
      filterNotes: "ノートを絞り込む",
      newNote: "新しいノート",
      resizeNotes: "ノート一覧のサイズを変更",
      noteTitle: "ノートのタイトル",
      untitled: "無題",
      noteSections: "ノートのセクション",
      preview: "プレビュー",
      source: "ソース",
      writeMarkdown: "Markdown を書く...",
      releaseNotes: "リリースノート",
      resizeTerminal: "ターミナルのサイズを変更",
      terminals: "ターミナル",
      moveTerminal: "ターミナルを移動",
      inboxSource: "受信トレイのソース",
      filterInbox: "受信トレイを絞り込む",
      resizeInbox: "受信トレイ一覧のサイズを変更",
      addConnection: "接続を追加",
      connectSource: "{source} を接続",
      notConnected: "未接続",
      addConnectionToStartInbox: "上で接続を追加すると、通知と Issue を受信トレイに取り込み始めます。",
      connectAnInboxSource: "受信トレイのソースを接続",
      prSections: "Pull request のセクション",
      summary: "概要",
      code: "コード",
      resizeDiscussion: "ディスカッションのサイズを変更",
      ...
      viewFullFile: "ファイル全体を表示",
      collapseFullFile: "コンテキストを折りたたむ",
      discardFile: "ファイルを破棄",
      stageFile: "ファイルをステージ",
      expandUp: "未変更行を上方向に展開",
      expandDown: "未変更行を下方向に展開",
      stageHunk: "ハンクをステージ",
      access: "アクセス",
      remove: "削除",
      customColor: "カスタムカラー",
      ...
      hue: "色相",
      projectPicker: "プロジェクトピッカー",
      moreProjects: "その他のプロジェクト",
      branchPicker: "ブランチピッカー",
      searchOrCreateBranch: "ブランチを検索または作成...",
      branches: "ブランチ",
      goToFile: "ファイルへ移動",
      files: "ファイル",
      markdownView: "Markdown ビュー",
      assignedToMe: "自分に割り当て",
      open: "オープン",
      draft: "下書き",
      closed: "クローズ",
      merged: "マージ済み",
      removeHandoff: "ハンドオフを削除",
      generateCommit: "コミットメッセージを生成",
      commitOptions: "コミットオプション",
      stagedChanges: "ステージされた変更",
      changes: "変更",
      discardChanges: "変更を破棄",
      unstageChanges: "ステージを解除",
      stageChanges: "変更をステージ",
      newFile: "新規ファイル",
      newFolder: "新規フォルダー",
      collapseAll: "すべて折りたたむ",
      typeFileName: "ファイル名を入力。Enter で確定、Escape でキャンセル。",
      dismissUpdate: "アップデート通知を閉じる",
      filterSessions: "セッションを絞り込む",
      archived: "アーカイブ済み",
      needsApproval: "承認が必要",
      done: "完了",
      dragReorderPane: "ドラッグしてペインを並べ替え",
      tabGroupActions: "タブグループの操作",
      groupName: "グループ名",
      removeProjectLogo: "プロジェクトロゴを削除",
      handoff: "ハンドオフ",
      buildWithAnotherModel: "別のモデルで構築",
      skills: "スキル",
      skillName: "スキル名",
      project: "プロジェクト",
      personal: "個人",
      ...
      networkSandbox: "ネットワークサンドボックス",
      networkSandboxTitle: "このセッションの送信ネットワークを許可ホスト一覧に制限します",
      ...
      showOn: "表示先",
      showBackgroundOn: "プロジェクト背景の表示先",
      visibility: "可視性",
      backgroundVisibility: "プロジェクト背景の可視性",
      commitMessage: "コミットメッセージ",
      openInPane: "ペインで開く",
      openPlanInPane: "プランをペインで開く",
      buildThisPlan: "このプランを構築",
      followUpBehavior: "フォローアップの動作",
      linear: "Linear",
      about: "情報",
      linearApiKey: "Linear API キー",
      filter: "フィルター",
      filterKeybindings: "キーバインドを絞り込む",
      archivedProjects: "アーカイブ済みプロジェクト",
      showArchivedSidebar: "アーカイブ済みをサイドバーに表示",
      showBackgroundOnRow: "背景の表示先",
      backgroundVisibilityRow: "背景の可視性",
      all: "すべて",
      conversations: "会話",
      searchScopeFiles: "ファイル",
      projects: "プロジェクト",
      closeNamed: "{name} を閉じる",
      goToFileShortcut: "ファイルへ移動 ({shortcut})",
      newSessionShortcut: "新しいセッション ({shortcut})",
      hideTerminalShortcut: "ターミナルを隠す ({shortcut})",
      terminalShortcut: "ターミナル ({shortcut})",
      settingsShortcut: "設定 ({shortcut})",
      newChat: "新しいチャット",
      closeOtherTabs: "他のタブを閉じる",
      closeTabsRight: "右側のタブを閉じる",
      closeTabsLeft: "左側のタブを閉じる",
      addToNewGroup: "新しいグループに追加",
      tabActionsFor: "{name} のタブ操作",
      newTabShortcut: "新しいタブ ({shortcut})",
      newTerminalShortcut: "新しいターミナル ({shortcut})",
      updatedTo: "MonoCode を {version} に更新しました",
      whatsNew: "新着情報",
      steer: "ステア",
      fxNoAttachments: "fx は添付ファイルに対応していません",
      queuePaused: "中断したためキューは一時停止しています",
      resume: "再開",
      attachmentCount: "{count, plural, one {# 件の添付} other {# 件の添付}}",
      status: "ステータス",
      time: "時間",
      allTime: "全期間",
      today: "今日",
      ...
      type: "種類",
      noProjectFolder: "プロジェクトフォルダーなし",
      releaseNotesUnavailable: "このバージョンのリリースノートは、このビルドでは利用できません。",
      hexColor: "16 進カラー",
      cut: "切り取り",
      openFile: "ファイルを開く",
      ...
      openInVoktty: "Voktty で開く",
      fileLinkActions: "ファイルリンクの操作",
      fileTabActions: "ファイルタブの操作",
      closeOthers: "他を閉じる",
      openCommitGraph: "Git グラフを開く",
      viewFileHistory: "ファイル履歴を表示",
      duplicate: "複製",
      openInTerminal: "ターミナルで開く",
      removeFromFolder: "フォルダーから削除",
      removeFromFolders: "フォルダーから削除",
      archive: "アーカイブ",
      unarchive: "アーカイブ解除",
      noMatchingSessions: "一致するセッションはありません",
      noSessionsMatchFilters: "これらのフィルターに一致するセッションはありません",
      sessionsEmptyHint: "開始したセッションがここに表示されます",
      sessionActions: "セッションの操作",
      folderActions: "フォルダーの操作",
      inboxNewItems: "受信トレイ、新しい項目",
      noMatchingLinearIssues: "一致する Linear の Issue はありません",
      noMatchingIssuesOrPrs: "一致する Issue または pull request はありません",
      noLinearIssuesMatchFilters: "これらのフィルターに一致する Linear の Issue はありません",
      noIssuesOrPrsMatchFilters: "これらのフィルターに一致する Issue または pull request はありません",
      noLinearIssues: "Linear の Issue はありません",
      openProjectToFillInbox: "プロジェクトを開いて受信トレイを埋めます",
      pullRequest: "Pull request",
      issue: "Issue",
      sending: "送信中...",
      sendToAgent: "エージェントに送信",
      reviewOnGitHub: "GitHub でレビュー",
      openInLinear: "Linear で開く",
      openOnGitHub: "GitHub で開く",
      chooseProject: "プロジェクトを選択",
      revealInFinder: "Finder で表示",
      revealInFileExplorer: "エクスプローラーで表示",
      openContainingFolder: "親フォルダーを開く",
      addToFolder: "{name} に追加",
      ask: "質問",
      sessions: "セッション",
      explorer: "エクスプローラー",
      hideChanges: "変更を隠す",
      ...
      viewAsList: "リスト表示",
      viewAsTree: "ツリー表示",
      openAllChanges: "すべての変更を開く",
      filesChanged: "{count, plural, one {# 個のファイルが変更されました} other {# 個のファイルが変更されました}}",
      ungroup: "グループ解除",
      pin: "ピン留め",
      unpin: "ピン留めを解除",
      pinned: "ピン留め済み",
      searchInFiles: "ファイル内を検索",
      searchInFilesShortcut: "ファイル内を検索 ({shortcut})",
      treeFiles: "{name} のファイル",
      dockBottom: "下にドッキング",
      dockTop: "上にドッキング",
      dockLeft: "左にドッキング",
      dockRight: "右にドッキング",
      newTabInGroup: "グループ内に新しいタブ",
      moveGroupToNewWindow: "グループを新しいウィンドウへ移動",
      moveToNewWindow: "新しいウィンドウへ移動",
      closeGroup: "グループを閉じる",
      deleteGroup: "グループを削除",
      emptyOnly: "空のみ",
      allSessions: "すべてのセッション",
      chooseBackgroundFor: "{name} の背景画像を選択",
      noBackgroundSelected: "背景が選択されていません",
      changeImage: "画像を変更",
      chooseImage: "画像を選択",
      chooseAnImage: "画像を選択",
      backgroundOverridesGlobal: "この画像は、このプロジェクトのグローバル背景を上書きします。",
      backgroundFollowsGlobal: "このプロジェクトは現在、グローバルな外観設定に従っています。",
      removeBackgroundImage: "背景画像を削除",
      pinProject: "プロジェクトをピン留め",
      unpinProject: "プロジェクトのピン留めを解除",
      openInEditor: "エディターで開く",
      lookingForEditors: "エディターを探しています…",
      noSupportedEditorsFound: "対応するエディターが見つかりません",
      resizeProjectSidebar: "プロジェクトサイドバーのサイズを変更",
      openProject: "プロジェクトを開く",
      projectOptions: "プロジェクトのオプション",
      noProjectsYet: "プロジェクトはまだありません",
      searchShortcut: "検索 ({shortcut})",
      contextUsage: "コンテキスト使用量",
      keepAllSessionChanges: "セッションの変更をすべて保持",
      reviewChanges: "変更をレビュー",
      undoAllSessionChanges: "セッションの変更をすべて元に戻す",
      undoLockedOtherSession: "このプロジェクトで別のセッションが実行中のため、元に戻せません",
      undoUnavailableExternal: "このセッション外でファイルが変更されたため、元に戻せません",
      undoAll: "すべて元に戻す",
      keepAll: "すべて保持",
      review: "レビュー",
      runningTerminals: "実行中のターミナル",
      approval: "承認",
      allow: "許可",
      deny: "拒否",
      searchOrCreateBranchAria: "ブランチを検索または作成",
      openProjectToSearchFiles: "プロジェクトを開いてファイルを検索",
      indexingFiles: "ファイルを索引中...",
      noFilesFound: "ファイルが見つかりません",
      noMatchingFiles: "一致するファイルはありません",
      typeFileNameToSearch: "ファイル名を入力して検索",
      skillStarterHint: "編集できるスターター SKILL.md を作成します。",
      skillNamePlaceholder: "skill-name",
      skillNameRules: "小文字の英字、数字、ハイフンのみ使用できます。",
      creating: "作成中...",
      queue: "キュー",
      provider: "プロバイダー",
      showOnEmptyHint: "空のセッションのみ、またはすべての会話。",
      visibilityHint: "長い会話でも読みやすいよう、控えめにしてください。",
      followUpBehaviorDesc: "アクティブなターンが終わるまでフォローアップをキューするか、ターンにすぐステアします。",
      linearApiKeyDesc: "Linear -> Settings -> Security & Access で個人 API キーを作成します。切断すると削除されます。",
      apiKey: "API キー",
      disconnect: "切断",
      command: "コマンド",
      keybinding: "キーバインド",
      when: "条件",
      noMatchingBindings: "一致するバインドはありません",
      showArchivedSidebarDesc: "アーカイブ済みの会話をアクティブな会話と並べて表示します。",
      archivedIn: "{name} にアーカイブ済み",
      archivedConversations: "アーカイブ済みの会話",
      replyToAuthor: "{name} に返信中",
      commentFallback: "コメント",
      writeReplyShortcut: "返信を書く ({shortcut})",
      leaveCommentShortcut: "コメントを残す ({shortcut})",
      posting: "投稿中...",
      reply: "返信",
      comment: "コメント",
      loadingComments: "コメントを読み込み中",
      askAbout: "{name} について質問",
      askDot: "質問 · {name}",
      tasks: "タスク",
      createNamed: "{name} を作成",
      switchToNamed: "{name} に切り替え",
      uncommittedChanges: "未コミットの変更",
      creatingBranchOverwrite: "{name} を作成するとローカルの変更が上書きされます。後で使えるよう stash するか、先にこのブランチへコミットしてください。",
      switchingBranchOverwrite: "{name} に切り替えるとローカルの変更が上書きされます。後で使えるよう stash するか、先にこのブランチへコミットしてください。",
      messageToCommitShortcut: "メッセージ（{shortcut} でコミット）",
      commitAndSwitch: "コミットして切り替え",
      stashAndSwitch: "stash して切り替え",
      noResults: "結果なし",
      searchMatchSummary: "{fileCount, plural, one {# ファイル} other {# ファイル}}内の {matchCount, plural, one {# 件} other {# 件}}",
      searchResultsLimited: " （上限あり）",
      typeToSearchProject: "入力してプロジェクト全体を検索",
      noFavoriteModels: "お気に入りのモデルはありません",
      loadingCodexModels: "Codex モデルを読み込み中...",
      noMatchingModels: "一致するモデルはありません",
      removeFromFavorites: "お気に入りから削除",
      addToFavorites: "お気に入りに追加",
      noRepo: "リポジトリなし",
      loadingBranch: "ブランチを読み込み中...",
      loadingBranchAria: "ブランチを読み込み中",
      noGitRepository: "Git リポジトリがありません",
      branchNamed: "ブランチ {name}",
      noMatchingBranches: "一致するブランチはありません",
      noBranches: "ブランチはありません",
      wipBeforeSwitching: "{name} に切り替える前の WIP",
      networkSandboxOn: "ネットワークサンドボックス: オン",
      networkSandboxOff: "ネットワークサンドボックス: オフ",
      removeNamed: "{name} を削除",
      colorIndex: "カラー {index}",
      projectNamed: "プロジェクト {name}",
      building: "構築中...",
      built: "構築済み",
      build: "構築",
      installProviderHandoff: "ハンドオフするには別のプロバイダーをインストール",
      handoffDescription: "このセッションを別のエージェントに渡して作業を続けます。",
      handoffMenu: "このセッションを別のエージェントに渡す",
      noBuildProviders: "利用できる構築プロバイダーはありません",
      buildPlanDescription: "このプランを構築するモデルとプロバイダーを選びます。",
      buildPlanMenu: "別のモデルまたはプロバイダーでこのプランを構築",
      secondOpinion: "セカンドオピニオン",
      installProviderSecondOpinion: "セカンドオピニオン用に別のプロバイダーをインストール",
      secondOpinionDescription: "このターンを別のエージェントに送り、作業をレビューします。",
      secondOpinionMenu: "このターンを別のエージェントに送る",
      settingsKeybindings: "キーバインド",
      settingsArchive: "アーカイブ",
      commentCount: "{count, plural, one {# 件のコメント} other {# 件のコメント}}",
      latestCommentsMoreOn: "最新のコメント · 続きは {name}",
      resolved: "解決済み",
      ghost: "ゴースト",
      openingFile: "{name} を開いています...",
      couldntOpenFile: "{name} を開けませんでした",
      saving: "保存中...",
      saveFailed: "保存に失敗しました: {message}",
      searchEmptyHint: "ファイル、会話、メッセージ、プロジェクトを検索します。",
      teams: "チーム",
      clearFilters: "フィルターをクリア",
      noMatchingSkills: "一致するスキルはありません",
      noSkillsYet: "スキルはまだありません",
      newSkill: "新しいスキル",
      openProjectFolder: "プロジェクト / フォルダーを開く...",
      currentProject: "現在のプロジェクト",
      recentProjects: "最近のプロジェクト",
      createAndCheckout: "{name} を作成してチェックアウト",
      newBranch: "新しいブランチ",
      newBranchDescription: "このプロジェクトでブランチを作成してチェックアウトします。",
      branchName: "ブランチ名",
      branchNamePlaceholder: "feature/my-branch",
      createBranch: "ブランチを作成",
      showLess: "表示を減らす",
      showMore: "さらに表示",
      moreCount: "さらに {count} 件",
      collapseFiles: "ファイルを折りたたむ",
      expandFiles: "ファイルを展開",
      filesCount: "{count, plural, one {# 個のファイル} other {# 個のファイル}}",
      sharedFile: "共有ファイル",
      compactNow: "今すぐ圧縮",
      waitForOperation: "現在の操作が完了するまでお待ちください",
      compactContext: "この会話のコンテキストを圧縮",
      connect: "接続",
      linearTeams: "Linear チーム",
      uncheckedTeamsHint: "チェックを外したチームは受信トレイに入りません。",
      needApproval: "承認が必要",
      workingEllipsis: "作業中...",
      openInNamed: "{name} で開く",
      openKindInProvider: "{kind} {id} を {provider} で開く",
      removeKindId: "{kind} {id} を削除",
      restore: "元に戻す",
      promptOutline: "プロンプト",
      promptPreview: "プロンプトのプレビュー",
  ...
  gitHistory: {
    ...
    workbench: {
      ...
      header: {
        noBranches: "ブランチが見つかりません",
        fetch: "フェッチ",
        fetchTooltip: "リモートから最新の参照をフェッチ",
        fetchSuccess: "リモートからフェッチしました",
        pull: "プル",
        pullTooltip: "fast-forward の変更をプル",
        pullSuccess: "変更をプルしました",
        push: "プッシュ",
        pushTooltip: "upstream ブランチへコミットをプッシュ",
        pushSuccess: "コミットをプッシュしました",
        refresh: "更新",
        refreshTooltip: "コミット履歴を更新",
        currentBranch: "現在のブランチ",
        allBranches: "すべてのブランチ",
        searchPlaceholder: "メッセージ、ハッシュ、作成者でコミットを検索...",
        dirty: "未コミットの変更",
        ahead: "{count} 件先行",
        behind: "{count} 件遅れ",
      },
    ...
    contextMenu: {
      viewDiff: "変更を表示 (Diff)",
      openSplitDiff: "分割ビューで Diff を開く",
      checkout: "コミットをチェックアウト",
      createBranch: "ここでブランチを作成...",
      createTag: "ここでタグを作成...",
      cherryPick: "コミットをチェリーピック...",
      revert: "コミットをリバート...",
      copy: "コピー",
      copySha: "完全な SHA をコピー",
      copyShortSha: "短い SHA をコピー",
      copySubject: "コミットメッセージをコピー",
      copyPatch: "パッチをコピー",
      openRemote: "{host} で開く",
    },
    checkoutSuccess: "コミット {sha} をチェックアウトしました",
    checkoutFailed: "コミットのチェックアウトに失敗しました",
    createTag: "タグを作成",
    createTagDescription: "{sha}（{subject}）を指す新しいタグを作成します。",
    tagFailed: "タグの作成に失敗しました",
    pulls: {
      title: "Pull Requests",
      refresh: "更新",
      loading: "pull request を読み込み中...",
      loadingDiff: "PR の diff を読み込み中...",
      searchPlaceholder: "pull request を検索...",
      noPulls: "オープンな pull request は見つかりませんでした。",
      noRemoteFound: "このプロジェクトの GitHub リモートリポジトリが見つかりません。",
      tokenRequiredTitle: "GitHub を接続して Pull Request を表示",
      tokenRequiredDesc: "personal access token (PAT) を追加すると、pull request の閲覧、レビュー、チェックアウトができます。",
      connectGithub: "GitHub を接続",
      setTokenBtn: "アクセストークンを設定",
      connectGithubTitle: "GitHub Personal Access Token",
      connectGithubDesc: "repo 権限のある personal access token を入力してください。",
      tokenSaved: "GitHub アクセストークンを保存しました",
      draftBadge: "下書き",
      openInBrowser: "ブラウザーで開く",
      checkoutPrBranch: "ブランチをチェックアウト",
      viewDiff: "Diff を表示",
      openSplitDiff: "分割ビューで開く",
      reviewPr: "PR をレビュー",
      headBranch: "Head ブランチ",
      baseBranch: "Base ブランチ",
      diffPreview: "PR Diff プレビュー",
      diffUnavailable: "この pull request の diff コンテンツはありません。",
      selectPrHint: "一覧から pull request を選ぶと、詳細と diff を表示します。",
      submitReviewTitle: "Pull Request #{number} をレビュー",
      approve: "承認",
      comment: "コメント",
      requestChanges: "変更をリクエスト",
      reviewBodyPlaceholder: "コメントまたはレビュー概要を入力...",
      submit: "レビューを送信",
    ...
    branches: {
      ...
      refresh: "更新",
      loading: "ブランチを読み込み中...",
      noMatches: "検索に一致するブランチはありません。",
      local: "ローカルブランチ",
      worktree: "Worktree ブランチ",
      checkout: "チェックアウト",
      checkoutSuccess: "{branch} をチェックアウトしました",
    ...
    worktrees: {
      ...
      add: "Worktree を追加",
      refresh: "更新",
      loading: "Worktree を読み込み中...",
      empty: "アクティブな補助 Worktree はありません。隔離して並行タスクを実行するには Worktree を作成してください。",
      active: "アクティブな Worktree",
      createSuccess: "Worktree を作成しました",
      removeSuccess: "Worktree を削除しました",
      removeConfirmTitle: "Worktree を削除しますか？",
      removeConfirmDesc: "Worktree \"{name}\" を削除しますか？未コミットの変更は削除されません。",
      cancel: "キャンセル",
      remove: "削除",
      branchPlaceholder: "Worktree 用の新しいブランチ名",
    },
    tagsStashes: {
      tags: "タグ",
      stashes: "Stash",
      refresh: "更新",
      tagNamePlaceholder: "タグ名（例: v1.0.0）",
      tagMessagePlaceholder: "任意のタグメッセージ",
      createTag: "タグを作成",
      stashMessagePlaceholder: "任意の stash メッセージ...",
      includeUntracked: "未追跡を含める",
      stashChanges: "変更を stash",
      loading: "読み込み中...",
      noTags: "タグが見つかりません。",
      pushTag: "タグをリモートへプッシュ",
      push: "プッシュ",
      noStashes: "stash が見つかりません。",
      apply: "適用",
      pop: "Pop",
      deleteTagTitle: "タグを削除しますか？",
      deleteTagDesc: "タグ \"{name}\" を削除しますか？",
      dropStashTitle: "Stash を破棄しますか？",
      dropStashDesc: "stash@{index} を破棄しますか？",
      cancel: "キャンセル",
      delete: "削除",
      drop: "破棄",
      tagCreated: "タグ \"{name}\" を作成しました",
      tagDeleted: "タグ \"{name}\" を削除しました",
      tagPushed: "タグ \"{name}\" をリモートへプッシュしました",
      stashApplied: "Stash@{index} を適用しました",
      stashPopped: "Stash@{index} を pop しました",
      stashDropped: "Stash@{index} を破棄しました",
    },
    remotes: {
      title: "リモートリポジトリ",
      refresh: "更新",
      loading: "リモート情報を読み込み中...",
      noRemote: "このリポジトリにリモートは設定されていません。",
      openInBrowser: "ブラウザーで開く",
      fetchAll: "すべてフェッチ",
      fetchSuccess: "リモートからフェッチしました",
      pull: "プル",
    ...
    compare: {
      ...
      btnCompare: "比較",
      refresh: "更新",
      hint: "「比較」をクリックして 2 つのブランチの差分を分析します。",
      loading: "ブランチを比較しています...",
      commitsAhead: "先行コミット",
      inBase: "{base} にあり {compare} にない",
      noAheadCommits: "先行コミットはありません。",
      commitsBehind: "遅れコミット",
      inCompare: "{compare} にあり {base} にない",
      noBehindCommits: "遅れコミットはありません。",
      changedFiles: "変更されたファイル",
      diff: "Diff",
    },
  },
  toolPreview: {
    ...
    attemptedChanges: "試行された変更 · ツールは完了しませんでした",
    writtenContent: "書き込まれた内容 · 以前の内容は利用できません",
    changePreview: "変更のプレビュー",
    openLabel: "{label} を開く",
    previewLabel: "{type} をプレビュー: {label}",
  ...
  notifications: {
    title: "Voktty",
    questionPrompt: "{harness} から質問があります",
    approvalNeeded: "{harness} の承認が必要です",
    approveTool: "承認: {what}",
    harnessFinished: "{harness} が完了しました",
  },
  lightbox: {
    preview: "画像プレビュー: {alt}",
    close: "画像プレビューを閉じる",
    openFullScreen: "{name} を全画面で開く",
  },
  skillsPage: {
    skillCount: "{count} {count, plural, one {件のスキル} other {件のスキル}}",
    filterPlaceholder: "フィルター",
    filterAriaLabel: "スキルを絞り込む",
    refreshSkills: "スキルを更新",
    refreshTooltip: "スキルフォルダーを再スキャン",
    addSkill: "スキルを追加",
    closeForm: "閉じる",
    addSkillAriaLabel: "スキルを追加",
    closeSkillFormAriaLabel: "スキルフォームを閉じる",
    addSkillTooltip: "編集できるスターター SKILL.md を作成",
    loading: "スキルを読み込み中…",
    noSkills: "スキルはまだありません。追加するとスターター SKILL.md が作成されます。",
    noMatchingSkills: "一致するスキルはありません",
    savePreferenceError: "スキルの設定を保存できませんでした。もう一度お試しください。",
    openFolderError: "フォルダーを開けませんでした: {error}",
    copyPathError: "パスをクリップボードにコピーできませんでした。",
    scopePersonal: "個人",
    scopeBuiltin: "Voktty",
    scopeProject: "プロジェクト",
    toggleAriaLabel: "{name} を Voktty カタログに含める",
    copyPath: "パスをコピー",
    copyPathAriaLabel: "{name} のパスをコピー",
    revealInFileManager: "ファイルマネージャーで表示",
    revealAriaLabel: "{name} をエクスプローラーで表示",
    previewSkill: "プレビュー",
    hideSkillPreview: "プレビューを隠す",
    previewAriaLabel: "{name} の内容をプレビュー",
    copySkillContent: "内容をコピー",
    copySkillContentAriaLabel: "{name} の内容をコピー",
    copiedSkillContent: "コピーしました",
    loadSkillError: "スキルの内容を読み込めませんでした: {error}",
    descriptionFooter: "非表示のスキルはディスク上に残り、Voktty のファイルスキルカタログからは除外されます。プロバイダー管理のスキルとネイティブコマンドは影響を受けません。スキルはこのプロジェクトでは .agents/skills、個人では ~/.agents/skills にあり、harness フォルダーも検出されます。",
  },
  questions: {
    question: "質問",
    skip: "スキップ",
    continue: "続行",
    interactToKeepOpen: "操作すると、この質問を開いたままにできます。",
    optionalQuestion: "任意の質問",
    autoResolvesIn: "{seconds} 秒後に回答なしで続行します",
    selectMultiple: "該当するものをすべて選択",
    typeYourAnswer: "回答を入力",
    other: "その他",
  },
  sessionReview: {
    changedFiles: "{count} {count, plural, one {個のファイル} other {個のファイル}}を変更しました",
    undo: "元に戻す",
    keep: "保持",
    review: "レビュー",
    undoAllSessionChanges: "セッションの変更をすべて元に戻す",
    undoLockedOtherSession: "このプロジェクトで別のセッションが実行中のため、元に戻せません",
    undoUnavailableExternal: "このセッション外でファイルが変更されたため、元に戻せません",
    keepAllSessionChanges: "セッションの変更をすべて保持し、このカードを閉じる",
    reviewChanges: "変更をレビュー",
    showFewerFiles: "ファイルの表示を減らす",
    showMoreFiles: "さらに {count} {count, plural, one {個のファイル} other {個のファイル}}を表示",
    sharedFile: "共有ファイル",
  },
};
const jaHarnessCopy: DeepPartial<TranslationSchema> = {
  "common": {
    "saving": "保存中..."
  },
  "harness": {
    "modelSettings": {
      "fastDescription": "現在のモデルが対応しているとき、優先処理を使います"
    },
    "settings": {
      "gitlab": "GitLab",
      "gitlabConnection": "GitLab 接続",
      "gitlabConnectionDesc": "GitLab.com または自前の GitLab に接続します。API 権限のある個人アクセストークンを使ってください。トークンはこの端末に保存され、切断すると削除されます。",
      "gitlabUrl": "GitLab URL",
      "gitlabToken": "GitLab アクセストークン",
      "connect": "接続",
      "disconnect": "切断"
    },
    "accounts": {
      "signedInTo": "{name} にサインインしました",
      "authenticationRequired": "認証が必要です",
      "retryLastMessage": "最後のメッセージをやり直せます。",
      "signInToContinue": "{name} を使い続けるにはサインインしてください。",
      "waitingForBrowser": "ブラウザーを待っています…",
      "signedIn": "サインイン済み",
      "signInTo": "{name} にサインイン",
      "signInRequired": "{name} へのサインインが必要です",
      "signIn": "サインイン",
      "signInDialog": "{name} のサインイン",
      "couldNotCompleteSignIn": "サインインを完了できませんでした",
      "removedAccount": "この会話は、もう存在しないプロバイダーアカウントを使っています。新しい会話を始めるには、使用量のコントロールからアカウントを切り替えてください。",
      "removedAccountShort": "削除されたアカウント",
      "defaultAccount": "既定のアカウント",
      "usageDetails": "{name} の使用量の詳細",
      "notConnected": "未接続",
      "notConnectedTitle": "未接続",
      "usageDetailsShort": "使用量の詳細",
      "usageTitle": "{name} の使用量",
      "switchAccount": "{name} のアカウントを切り替え",
      "updating": "更新中",
      "couldntRefresh": "更新できませんでした。最後に取得できた状態を表示しています。",
      "switchAccountFrom": "{name} からアカウントを切り替え",
      "switch": "切り替え",
      "backToUsage": "使用量に戻る",
      "accountsTitle": "{name} のアカウント",
      "accountPinned": "各会話は、開始したアカウントに固定されたままです。",
      "addAccount": "アカウントを追加",
      "manageAccounts": "アカウントを管理…",
      "backToAccounts": "アカウントに戻る",
      "addNamedAccount": "{name} のアカウントを追加",
      "addAccountHint": "このアカウントにローカル名を付け、ブラウザーでサインインを完了してください。",
      "accountName": "アカウント名",
      "workOrPersonal": "仕事用または個人用",
      "signInAndAddAccount": "サインインしてアカウントを追加",
      "couldNotCreateAccount": "アカウントを作成できませんでした",
      "fiveHourLimit": "5 時間の上限",
      "weeklyLimit": "週間の上限",
      "monthlyLimit": "月間の上限",
      "windowLimit": "{window}の上限",
      "percentUsed": "{percent} 使用",
      "limitUsed": "{title}を使用",
      "percentRemaining": "残り {percent}%",
      "windowName": "{window}の期間",
      "bankedResets": "蓄積リセット",
      "notReported": "このアカウントは報告していません",
      "noResets": "使えるリセットはありません",
      "resetsAvailable": "{count, plural, one {リセットがあと # 回} other {リセットがあと # 回}}",
      "availableBankedResets": "使える蓄積リセット",
      "bankedReset": "蓄積リセット {index}",
      "expiryNotProvided": "期限は提供されていません",
      "expiresNow": "今期限切れ",
      "expiresIn": "{time}後に期限切れ",
      "applying": "適用中…",
      "useReset": "リセットを使う",
      "spendReset": "このリセットを今使いますか？",
      "loadingUsage": "使用量を読み込み中…",
      "usageUnavailable": "使用量を取得できません",
      "rateLimitDetails": "上限の詳細",
      "updatedJustNow": "たった今更新",
      "updatedMinutesAgo": "{count} 分前に更新",
      "updatedHoursAgo": "{count} 時間前に更新",
      "resetDone": "Codex の使用量をリセットしました。",
      "nothingToReset": "リセットする進行中の使用量はありません。",
      "noCredit": "使える蓄積リセットはありません。",
      "alreadyRedeemed": "このリセットはすでに使われています。",
      "expired": "期限切れ",
      "settingsTitle": "アカウント",
      "settingsDescription": "アカウントプロファイルに対応するプロバイダー向けに、分離したサインインを作成します。アカウントの切り替えはフッターの使用量コントロールから行えます。",
      "accountCount": "{count, plural, one {# 件のアカウント} other {# 件のアカウント}}",
      "providerCliProfile": "プロバイダー CLI のプロファイル",
      "isolatedProfile": "分離プロファイル",
      "renameNamed": "{name} の名前を変更",
      "renameAccount": "アカウント名を変更",
      "removeNamed": "{name} を削除",
      "removeAccount": "アカウントを削除",
      "removeConfirm": "「{name}」を削除しますか？保存した資格情報は消去され、このアカウントで進行中のターンは停止します。会話は履歴に残りますが、アカウントを切り替えるまで続行できません。",
      "removeAccountTitle": "{name} のアカウントを削除",
      "couldNotSaveAccount": "このアカウントを保存できませんでした",
      "couldNotRemoveAccount": "このアカウントを削除できませんでした",
      "newNamedAccount": "新しい {name} アカウント",
      "renameNamedAccount": "{name} アカウントの名前を変更",
      "signInAndAdd": "サインインして追加"
    },
    "projectGroups": {
      "newGroup": "新しいグループ…",
      "ungrouped": "グループなし",
      ...
      "projectsUngrouped": "プロジェクトはグループなしになります",
      "groupOptions": "グループのオプション",
      "namedGroupOptions": "{name} のグループオプション",
      "projectCount": "{count, plural, one {# 件のプロジェクト} other {# 件のプロジェクト}}",
      "groupSummary": "{name}、{detail}",
      "groupSummaryTitle": "{name} · {detail}",
      "actions": "プロジェクトグループの操作"
    },
    "binary": {
      "opening": "{name} を開いています…",
      "couldntOpen": "{name} を開けませんでした",
      "notReadableImage": "{size} · 読み取れる画像ではありません",
      "copyOriginalFile": "元のファイルをコピー",
      "copyOriginalFileMenu": "元のファイルをコピー",
      "imageActions": "画像の操作",
      "zoomOut": "縮小",
      "zoomIn": "拡大",
      "fit": "合わせる",
    ...
    "reminders": {
      "inOneHour": "1 時間後 ({time})",
      "inThreeHours": "3 時間後 ({time})",
      "thisEvening": "今夜 (18:00)",
      "tomorrow": "明日 (9:00)",
      "nextWeek": "来週（月 9:00）"
    },
    "modelPicker": {
      "modelAndEffort": "モデルと努力",
      "model": "モデル",
      "recentHint": "{harness} · {model} · 最近のモデル: 右クリックまたは {shortcut}。",
      "recentlyUsed": "最近使ったモデル",
      "models": "モデル",
      "providers": "プロバイダー",
      "favorites": "お気に入り",
      "searchModels": "モデルを検索",
    ...
    "terminals": {
      "hideProcess": "{name} を隠す",
      "showProcess": "{name} を表示",
      "hideRunning": "実行中のターミナルを隠す",
      "runningCount": "{count} 個のターミナルがプロセスを実行中です",
      "processIn": "{label} の \"{process}\""
    },
    "keybindings": {
      "always": "常に",
      "commands": {
        "appSearch": "アプリ: 検索",
        "goToFile": "アプリ: ファイルへ移動",
        "commandPalette": "アプリ: コマンドパレット",
        "findInFiles": "アプリ: ファイル内を検索",
        "openProject": "アプリ: プロジェクトを開く",
        "newWindow": "アプリ: 新しいウィンドウ",
        "toggleSidebar": "アプリ: サイドバーの切り替え",
        "toggleZen": "アプリ: 禅モード",
        "switchModel": "アプリ: モデルを切り替え",
        "reload": "表示: 再読み込み",
        "tabNew": "タブ: 新規",
        "tabNext": "タブ: 次へ",
        "tabPrevious": "タブ: 前へ",
        "tabCycleNext": "タブ: 次を循環",
        "tabCyclePrevious": "タブ: 前を循環",
        "tabBack": "タブ: 戻る",
        "tabForward": "タブ: 進む",
        "tabCloseOthers": "タブ: 他を閉じる",
        "tabActivateRange": "タブ: 1–8 を有効化",
        "tabActivateLast": "タブ: 最後を有効化",
        "sessionArchive": "セッション: アーカイブ",
        "sessionPrevious": "セッション: 前へ",
        "sessionNext": "セッション: 次へ",
        "projectPrevious": "プロジェクト: 前へ",
        "projectNext": "プロジェクト: 次へ",
        "paneClose": "ペイン: 閉じる",
        "paneSplitRight": "ペイン: 右に分割",
        "paneSplitDown": "ペイン: 下に分割",
        "paneFocusLeft": "ペイン: 左にフォーカス",
        "paneFocusRight": "ペイン: 右にフォーカス",
        "paneFocusUp": "ペイン: 上にフォーカス",
        "paneFocusDown": "ペイン: 下にフォーカス",
        "terminalNew": "ターミナル: 新規",
        "terminalNewTab": "ターミナル: 新しいタブ",
        "terminalToggleDock": "ターミナル: ドックの切り替え",
        "editorFind": "エディター: 検索",
        "editorReplace": "エディター: 置換"
      }
    },
    "settingsEntries": {
      "version": "バージョン",
      ...
      "hue": "色相",
      "saturation": "彩度",
      "darkLightness": "ダークモードの明度",
      "sidebarOpacity": "サイドバーの不透明度",
      "blur": "ぼかし半径",
      "mainPaneGlass": "メインペインのガラス",
      "interfaceScale": "画面の倍率",
      "chatBackground": "チャットの背景",
      "transcriptLayout": "トランスクリプトのレイアウト",
      "anchorPrompts": "プロンプトを上に固定",
      "followUp": "フォローアップの動作",
      "effortControl": "努力の制御",
      "composerMascot": "コンポーザーのマスコット",
      "diffView": "差分表示",
      "emptySessionGames": "空のセッションのゲーム",
      "providerAccounts": "プロバイダーアカウント",
      "claudeHooks": "Claude Code フック",
      "github": "GitHub",
      "gitlab": "GitLab",
      "linear": "Linear",
      "showArchived": "アーカイブをサイドバーに表示"
    }
  }
};
export const ja: TranslationSchema = mergeLocale(mergeLocale(mergeLocale(mergeLocale(mergeLocale(mergeLocale(mergeLocale(mergeLocale(mergeLocale(mergeLocale(mergeLocale(jaCoveragePatch, jaGitTranslations), jaOnboardingTranslations), jaShortcutTranslations), jaCommonTranslations), jaCommandPaletteTranslations), jaWorkbenchTranslations), jaStatusTranslations), jaThemeTranslations), {
  common: {
    paste: "貼り付け",
  },
  commandPalette: {
    commands: {
      openTasksPanel: "表示: タスク",
      openTestsPanel: "表示: テスト",
      openDebugPanel: "表示: デバッグ",
    },
  },
}), jaGapFill), jaHarnessCopy);
