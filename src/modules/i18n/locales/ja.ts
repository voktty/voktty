...
const jaBase = mergeLocale(en, {
  ...
  launcher: {
    title: "ランチパッド",
    description: "Voktty のあらゆるツールを開きます。入力で絞り込み、矢印で移動、Enter で起動します。",
    placeholder: "ツールを検索...",
    empty: "一致するツールがありません。",
    hints: {
      navigate: "移動",
    ...
    items: {
      terminal: "ターミナル",
      blockTerminal: "ブロックターミナル",
      privateTerminal: "プライベートターミナル",
      commandHistory: "コマンド履歴",
      ssh: "SSH 接続",
      serial: "シリアルポート",
      rdp: "リモートデスクトップ",
      guestConnect: "共有セッションに参加",
      sshSettings: "SSH とトンネル",
      dockerSettings: "Docker",
      rdpSettings: "リモートデスクトップのホスト",
      editor: "エディタ",
      openFile: "ファイルを開く",
      quickOpen: "クイックオープン",
      search: "ファイル内を検索",
      ...
      harness: "ハーネス",
      aiAgent: "AI エージェント",
      agentHistory: "エージェント履歴",
      harnessSettings: "ハーネス設定",
      settings: "設定",
  ...
  gitHistory: {
    ...
    viewChanges: "変更を表示",
    cherryPick: "チェリーピック",
    cherryPickConfirmTitle: "このコミットを適用しますか?",
    cherryPickConfirmDescription: "{subject} ({sha}) を現在のブランチに適用します。",
    cherryPickSuccess: "コミットを適用しました",
    cherryPickFailed: "コミットを適用できませんでした",
    createBranch: "新しいブランチ",
    createBranchDescription: "{subject} ({sha}) からブランチを作成してチェックアウトします。",
    branchNamePlaceholder: "ブランチ名",
    branchCreated: "ブランチ {name} を作成しました",
    branchFailed: "ブランチを作成できませんでした",
    copyPatch: "パッチをコピー",
    copyPatchFailed: "パッチをコピーできませんでした",
    patchTruncated: "コミットが非常に大きいためパッチは切り詰められました",
    copySha: "SHA をコピー",
    copied: "コピーしました",
