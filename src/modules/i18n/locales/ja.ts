...
export const ja: TranslationSchema = mergeLocale(mergeLocale(mergeLocale(mergeLocale(mergeLocale(mergeLocale(mergeLocale(mergeLocale(mergeLocale(mergeLocale(jaCoveragePatch, jaGitTranslations), jaOnboardingTranslations), jaShortcutTranslations), jaCommonTranslations), jaCommandPaletteTranslations), jaWorkbenchTranslations), jaStatusTranslations), jaThemeTranslations), {
  common: {
    paste: "貼り付け",
  },
  commandPalette: {
