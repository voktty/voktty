...
function distroCommand(key: DistroKey, version: string): string {
  switch (key) {
    case "arch":
      return "yay -S voktty-bin";
    case "debian":
      return `sudo apt install ./Voktty_${version}_amd64.deb`;
    case "fedora":
      return `sudo dnf install ./Voktty-${version}-1.x86_64.rpm`;
  }
}
