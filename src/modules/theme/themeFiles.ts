...
const THEME_FILE_EXT = ".voktty-theme";
const THEME_EDIT_EVENT = "voktty://theme-edit";
...
export function starterTheme(): Theme {
  ...
  return {
    id,
    name: translate("settings.themes.customName"),
    description: translate("settings.themes.customDescription"),
    variants: {
      dark: {
        colors: {
          background: "#0d0d10",
