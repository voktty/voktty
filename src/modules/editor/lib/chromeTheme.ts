...
const chrome = EditorView.theme({
  ...
  ".cm-lsp-inlay-type": {
    color: "color-mix(in srgb, var(--primary) 72%, var(--muted-foreground))",
  },
  ".cm-lsp-inlay-parameter": {
    fontStyle: "italic",
  },
  ".cm-lsp-inlay-pad-left": {
    marginLeft: "0.45ch",
  },
  ".cm-lsp-inlay-pad-right": {
    marginRight: "0.45ch",
  },
  ...
  ".cm-lsp-code-actions": {
    ...
    "& .cm-lsp-code-actions-primary": {
      overflow: "hidden",
      fontWeight: "500",
      textOverflow: "ellipsis",
      whiteSpace: "nowrap",
    },
    "& .cm-lsp-code-actions-detail, & .cm-lsp-code-actions-disabled": {
      overflow: "hidden",
      color: "var(--muted-foreground)",
      fontSize: "10.5px",
      textOverflow: "ellipsis",
