...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            harness::checkpoint::session_checkpoint_prepare,
            ...
            harness::checkpoint::session_checkpoint_file_diff,
            ...
            harness::session_store::session_list_linked,
            ...
            harness::fs::git_github_work_item,
            ...
            harness::gitlab::gitlab_status,
            harness::gitlab::gitlab_set_config,
            harness::gitlab::gitlab_repo,
            harness::gitlab::gitlab_list_work_items,
            harness::gitlab::gitlab_work_item_details,
            harness::gitlab::gitlab_work_item_thread,
            harness::gitlab::gitlab_work_item_comment,
            harness::gitlab::gitlab_mr_diff,
